    ...
    <div>
     <div class="left">
         ...
         <div id="Step2Container">
           <div class="title"><b> 裁剪头像照片</b></div>
           <div class="uploadtooltip">您可以拖动照片以裁剪满意的头像</div>                              
                   <div id="Canvas" class="uploaddiv">
                    ...
                    <form action="/hadoopsensor/sevlet/ZoomImage.servlet" method="post">
      ...
      <form name="form1" method="post" action="/hadoopsensor/sevlet/UpLoadUserHeadImage.servlet" id="form1" enctype="multipart/form-data">
     <div class="right">
         <!--Step 1-->
