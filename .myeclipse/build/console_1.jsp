...
<%@ page import=" java.text.*,java.util.*,javax.naming.*,javax.sql.*,java.sql.Connection,java.sql.DriverManager,java.sql.ResultSet,java.sql.SQLException,java.sql.Statement,com.opensymphony.xwork2.ActionContext" %>
        ...
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <%
				...
				Connection conn0_3 = ds.getConnection();
...
<%
				...
				Connection conn0_4 = ds.getConnection();
            ...
            <%
				...
				Connection conn0_5 = ds.getConnection();
            ...
            <%
				...
				Connection conn0_6 = ds.getConnection();
		...
		<!-- 节点7 -->          
            <%
				...
				Connection conn0 = ds.getConnection();
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        	...
        	<div class="tab-content">
        		<div role="tabpanel" class="tab-pane fade in active" id="table">
					...
					<%
						//	Class.forName("com.mysql.jdbc.Driver");
						//	String url="jdbc:mysql://localhost:3306/field_monitor?user=root&password=19911112&useUnicode=true&characterEncoding=GBK";
								...
								<div class="row">
										<div class="form-group col-md-6">
							                ...
							                <div class="input-group date form_date col-md-6" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1" data-link-format="yyyy-mm-dd">
							                    <input class="form-control" name="stdate" size="16" type="text" value="">
									...
									datasets : [
										{
											...
											data : [
						<%
											rs=stat.executeQuery("select * from tb_sensorinfo_1 order by id desc limit 50;");
											double light=0.0;
											while(rs.next())
											{
        ...
        <!-- 以下是历史数据的图表 -->
						...
						<%
											...
											try{
											  stdate=df.parse((String)request.getParameter("stdate"));
											...
											String sql = "select * from tb_sensorinfo_1 where date<= ";
											sql =sql +enddate+" and createDate>= "+stdate+" order by id desc limit 50;";
						...
						%>	
										...
										},
										{
											...
											data : [
						<%
											rs=stat.executeQuery("select * from tb_sensorinfo_1 order by id limit 50;");
											soilhumi=0.0;
											while(rs.next())
											{
													humi=rs.getDouble(8);
