					...
					<div class="blog_desc">
						<div class="section group example">								
							<div class="blog_heading">
							 ...
							 <div class="blog_data">
									<p>智能家居用户可以使用智能终端（手机、平板电脑等无线上网设备)，可以随时随地的登录云平台，查看智能家居状况、修改策略、查看系统建议、远程控制等，并向其发送指令或接受信息。极大的方便了用户的使用，为用户带来更好的体验。在智能云平台的支持下，即使客户不在家中，也可以对家中设备(灯光、门窗、窗帘、空调、电视和地加热设备等)进行远程集中监视控制，并且还可以设置各种情景模式，定时开关灯、窗帘等，提高住宅的安全性。</p>	
			                 </div>
			                 <div class="blog_heading">
								<p><span>智慧医疗</span></p>
						     </div>
			                 ...
			                 <div class="blog_data">
									<p>利用物联网、云计算、移动互联网、车联网、手机、平板电脑、PC 以及遍布地球各个角落的各种各样的传感器作为信息载体，使用专业技术进一步挖掘分析农业大数据，发现隐藏于背后的规律，从而实现农业生产环境的智能预警、智能决策、智能分析。</p>	
			                 </div>
			                 <div class="blog_heading">
								<p><span>工业4.0</span></p>
						     </div>
			                 <div class="blog_data">
									<p>工业4.0或工业互联网本质上是互联网运动神经系统的萌芽，互联网中枢神经系统也就是云计算中的软件系统控制工业企业的生产设备，家庭的家用设备，办公室的办公设备，通过智能化，3D打印，无线传感等技术使的机械设备成为互联网大脑改造世界的工具。同时这些智能制造和智能设备也源源不断向互联网大脑反馈大数据数，供互联网中枢神经系统决策使用。</p>	
			                 </div>
