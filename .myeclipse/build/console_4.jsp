        	...
        	<div class="tab-content">
        		<div role="tabpanel" class="tab-pane fade in active" id="table">
					...
					<%
							...
							ResultSet rs=stat.executeQuery("select * from tb_sensorinfo_4 order by id desc limit 50;");
							
							Connection conn1 = DriverManager.getConnection(url);
							Statement stat1=conn1.createStatement();
							ResultSet rs1=stat1.executeQuery("select * from sensor where node_id=4 ;");
        		...
        		<div role="tabpanel" class="tab-pane fade active" id="node_info">
        			<h3>节点传感器信息</h3>
	        			...
	        			<table class="table table-striped">
	        				...
	        				<%
								...
								rs=stat.executeQuery("select * from sensor where node_id=4;");
					...
					<h3>节点信息管理</h3>						
						...
						<%
							...
							ResultSet rs2=stat2.executeQuery("SELECT site FROM nodeinfo where node_id=04 and id = (select max(id) from nodeinfo where node_id=04);");
							String site = "未设置";
							while(rs2.next())
							{
									...
									datasets : [
										{
											...
											data : [
						<%
											rs=stat.executeQuery("select * from tb_sensorinfo_4 order by id desc limit 50;");
											double light=0.0;
											while(rs.next())
											{
