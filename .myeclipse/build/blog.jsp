			...
			<div class="container">
				...
				<div class="top-menu">
					...
					<nav class="cl-effect-5">
						...
						<li><a href="photos.jsp"><span data-hover="Photos">Photos</span></a></li> 
						<li><a href="404.jsp"><span data-hover="Care">Care</span></a></li> 
						<li><a class="active" href="blog.jsp"><span data-hover="Blog">Blog</span></a></li> 
			...
			<div class="section group">
					  ...
					  <div class="blog_posts">
						<div class="section group example">
							<div class="col blog_1_of_2">
				                <div class="blog_img">
										<a href="single.jsp"><img src="images/about-img2.jpg" alt=""></a>
				                </div>
							</div>
								<div class="col blogdata_1_of_2">
									<div class="blog_heading">
									<p><a href="single.jsp"><span>Lorem ipsum dolor sit amet consec.</span></a></p>
				                    ...
				                    <div class="more">
				         	  		<a href="single.jsp" class="btn btn-1 btn-1d">Read More</a>
				         	  			</div>
				                   </div>
								</div>
								 <div class="clearfix"></div>	
				...
				<div class="blog_posts">
						<div class="section group example">			
							<div class="col blog_1_of_2">
				                <div class="blog_img">
				                	<a href="single.jsp"><img src="images/about-img1.jpg" alt=""></a>
				                </div>
							</div>
								<div class="col blogdata_1_of_2">
								<div class="blog_heading">
				...
				<div class="blog_posts">
						<div class="section group example">		
							<div class="col blog_1_of_2">
				                <div class="blog_img">
				                	<a href="single.jsp"><img src="images/about-img3.jpg" alt=""></a>
				                </div>
							</div>
								<div class="col blogdata_1_of_2">
								<div class="blog_heading">
