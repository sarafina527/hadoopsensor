        	...
        	<div class="tab-content">
        		<div role="tabpanel" class="tab-pane fade in active" id="table">
					...
					<%
							...
							ResultSet rs1=stat1.executeQuery("select * from sensor where node_id=3 ;");
        		...
        		<div role="tabpanel" class="tab-pane fade active" id="node_info">
        			<h3>节点传感器信息</h3>
	        			...
	        			<table class="table table-striped">
	        				...
	        				<%
								...
								rs=stat.executeQuery("select * from sensor where node_id=3;");
					...
					<h3>节点信息管理</h3>						
						...
						<%
							...
							ResultSet rs2=stat2.executeQuery("SELECT site FROM nodeinfo where node_id=03 and id = (select max(id) from nodeinfo where node_id=03);");
							String site = "未设置";
							while(rs2.next())
							{
