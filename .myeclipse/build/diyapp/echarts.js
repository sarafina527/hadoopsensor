...
!function(e) {
    ...
    function h(t) {
        ...
        var n, a = A[t];
        a.invokeFactory = i,
        T(a.depPMs, function(e) {
            p(e, function() {
                T(a.depRs, function(i) {
                    i.absId || i.mod !== e || (i.absId = v(i.id, t),
                    g([i.absId], s))
                }
                )
            }
    ...
    function g(t, i, n, a) {
        function o() {
            if (!l) {
                var n = 1;
                T(t, function(e) {
                    return H[e] ? void 0 : n = !!d(e, F)
                }
                ),
                n && (l = 1,
                "function" == typeof i && i.apply(e, c(t, H)))
            }
        }
        if ("string" == typeof t) {
            if (m(t),
        ...
        a = a || {};
        var l = 0;
        t instanceof Array && (o(),
        l || (T(t, function(e) {
            H[e] || d(e, F) || (p(e, o),
            a[e] || (e.indexOf("!") > 0 ? f : y)(e, n),
            r(e))
        }
        ),
        s()))
    ...
    function y(e) {
        ...
        if (!B[e] && !A[e]) {
            ...
            i.setAttribute("data-require-id", e),
            i.src = k(e + ".js"),
            i.async = !0,
            i.readyState ? i.onreadystatechange = t : i.onload = t,
            K(i)
        }
    }
    function f(e, t) {
    ...
    function k(e) {
        ...
        /^([a-z]{2,10}:\/)?\//i.test(s) || (s = G.baseUrl + s),
        s += n + o,
        x(a, Z, function(e) {
            s += (s.indexOf("?") > 0 ? "&" : "?") + e
        }
    ...
    function I() {
        if ($)
            return $;
        if (et && "interactive" === et.readyState)
            return et;
    ...
    function K(e) {
        $ = e,
        it ? tt.insertBefore(e, it) : tt.appendChild(e),
        $ = null 
    }
    function S(e) {
        return new RegExp("^" + e + "(/|$)")
...
define("echarts/echarts", ["require", "./config", "zrender/tool/util", "zrender/tool/event", "zrender/tool/env", "zrender", "zrender/config", "./chart/island", "./component/toolbox", "./component", "./component/title", "./component/tooltip", "./component/legend", "./util/ecData", "./chart", "zrender/tool/color", "./component/timeline", "zrender/shape/Image", "zrender/loadingEffect/Bar", "zrender/loadingEffect/Bubble", "zrender/loadingEffect/DynamicLine", "zrender/loadingEffect/Ring", "zrender/loadingEffect/Spin", "zrender/loadingEffect/Whirling", "./theme/default"], function(e) {
    ...
    s.init = function(t, n) {
        var a = e("zrender");
        (a.version || "1.0.3").replace(".", "") - 0 < s.dependencies.zrender.replace(".", "") - 0 && console.error("ZRender " + (a.version || "1.0.3-") + " is too old for ECharts " + s.version + ". Current version need ZRender " + s.dependencies.zrender + "+"),
    ...
    return i.prototype = {
        ...
        _render: function(t) {
            ...
            for (var u, V, U, g = {}, c = 0, p = t.series.length; p > c; c++)
                ...
                this.chart[V] = U) : console.error(V + " has not been required.")) : console.error("series[" + c + "] chart type has not been defined.");
            for (V in this.chart)
            ...
            t.renderAsImage && l ? (f ? f.src = this.getDataURL(t.renderAsImage) : (f = this.getImage(t.renderAsImage),
            f.id = y,
            f.style.position = "absolute",
            f.style.left = 0,
            f.style.top = 0,
            this.dom.firstChild.appendChild(f)),
            this.un(),
            this._zr.un(),
            this._disposeChartList(),
            this._zr.clear()) : f && f.parentNode.removeChild(f),
            f = null ,
            this._option = t
        },
        restore: function() {
        ...
        _mergeGlobalConifg: function(t) {
            ...
            var o = t.color;
            o && o.length || (o = this._themeConfig.color),
            l || (t.animation = !1,
        ...
        addData: function(e, t, i, n, r) {
            for (var s = e instanceof Array ? e : [[e, t, i, n, r]], l = this.getOption(), h = this._optionRestore, d = 0, m = s.length; m > d; d++) {
                ...
                if (c) {
                    ...
                    null  != r) {
                        var g, y;
                        if (c.type === a.CHART_TYPE_PIE && (g = h.legend) && (y = g.data)) {
                            var f = l.legend.data;
                            if (y[p](r),
                            f[p](r),
                            !n) {
                                var b = o.indexOf(y, t.name);
                                -1 != b && y.splice(b, 1),
                                b = o.indexOf(f, t.name),
                                -1 != b && f.splice(b, 1)
                            }
                        } else if (null  != h.xAxis && null  != h.yAxis) {
                            var _, x, k = c.xAxisIndex || 0;
                            (null  == h.xAxis[k].type || "category" === h.xAxis[k].type) && (_ = h.xAxis[k].data,
                            x = l.xAxis[k].data,
                            _[p](r),
                            x[p](r),
                            n || (_[u](),
                            x[u]())),
                            k = c.yAxisIndex || 0,
                            "category" === h.yAxis[k].type && (_ = h.yAxis[k].data,
                            x = l.yAxis[k].data,
                            _[p](r),
                            x[p](r),
                            n || (_[u](),
            ...
            this._zr.clearAnimation();
            for (var L = this._chartList, d = 0, m = L.length; m > d; d++)
                l.addDataAnimation && L[d].addDataAnimation && L[d].addDataAnimation(s);
            ...
            return setTimeout(function() {
                if (v._zr) {
                    ...
                    for (var e = 0, t = L.length; t > e; e++)
                        L[e].motionlessOnce = l.addDataAnimation && L[e].addDataAnimation;
                    v._messageCenter.dispatch(a.EVENT.REFRESH, null , {
                        option: l
                    }, v)
                }
            }
            , l.addDataAnimation ? 500 : 0),
            this
        },
        ...
        showLoading: function(t) {
            ...
            n.textFont = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily,
            n.text = t.text || this._themeConfig.loadingText,
            null  != t.x && (n.x = t.x),
            null  != t.y && (n.y = t.y),
            t.effectOption = t.effectOption || {},
            t.effectOption.textStyle = n;
            var r = t.effect;
            return ("string" == typeof r || null  == r) && (r = i[t.effect || "spin"]),
        ...
        setTheme: function(t) {
            if (t) {
                ...
                for (var i in a)
                    this._themeConfig[i] = o.clone(a[i]);
                t.color && (this._themeConfig.color = []),
                t.symbolList && (this._themeConfig.symbolList = []),
                o.merge(this._themeConfig, o.clone(t), !0)
            }
            l || (this._themeConfig.textStyle.fontFamily = this._themeConfig.textStyle.fontFamily2),
...
define("zrender/tool/util", ["require", "../dep/excanvas"], function(e) {
    ...
    function a() {
        if (!d)
            ...
            window.G_vmlCanvasManager) {
                ...
                d = G_vmlCanvasManager.initElement(t).getContext("2d")
            } else
                d = document.createElement("canvas").getContext("2d");
        return d
    }
    function o() {
        return c || (m = document.createElement("canvas"),
        p = m.width,
        u = m.height,
        c = m.getContext("2d")),
        c
    ...
    function r(e, t) {
        ...
        m.height = u,
        i = !0),
        -U > e && (U = Math.ceil(-e / n) * n,
        p += U,
        m.width = p,
        i = !0),
        -g > t && (g = Math.ceil(-t / n) * n,
        u += g,
        m.height = u,
        i = !0),
        i && c.translate(U, g)
...
define("zrender/zrender", ["require", "./dep/excanvas", "./tool/util", "./tool/log", "./tool/guid", "./Handler", "./Painter", "./Storage", "./animation/Animation", "./tool/env"], function(e) {
    ...
    m.prototype.animate = function(e, t, a) {
        ...
        e) {
            ...
            return "undefined" == typeof e.__aniCount && (e.__aniCount = 0),
            0 === e.__aniCount && d.push(e),
            e.__aniCount++,
...
define("echarts/chart/island", ["require", "../component/base", "./base", "zrender/shape/Circle", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/event", "zrender/tool/color", "../util/accMath", "../chart"], function(e) {
    ...
    return t.prototype = {
        ...
        _combine: function(t, i) {
            ...
            t.style.text = s + this._valueConnector + o,
            r.set(t, "value", o),
            r.set(t, "name", s),
        ...
        ondragend: function(e, t) {
            ...
            t.needRefresh = !0) : t.dragIn || (i.style.x = l.getX(e.event),
            i.style.y = l.getY(e.event),
            this.add(i),
            t.needRefresh = !0),
            this.isDragend = !1
        }
    ...
    return t.prototype = {
        ...
        _buildItem: function() {
            ...
            for (var V = this, U = 0; l > U; U++) {
                ...
                t.highlightStyle.textY = "top" === o ? d + m + 10 : d - 10),
                U === l - 1 && "right" === n && (t.highlightStyle.textPosition = "specific",
                t.highlightStyle.textAlign = n,
                t.highlightStyle.textBaseline = o,
                t.highlightStyle.textX = h + m,
                t.highlightStyle.textY = "top" === o ? d + m + 10 : d - 10)),
                this._iconList[U]) {
                case "mark":
                    t.onclick = V._onMark;
        ...
        _buildBackground: function() {
            ...
            this.shapeList.push(new o({
                ...
                hoverable: !1,
                style: {
                    x: this._itemGroupLocation.x - a,
                    y: this._itemGroupLocation.y - t,
                    width: this._itemGroupLocation.width + a + i,
                    height: this._itemGroupLocation.height + t + n,
        ...
        _getItemGroupLocation: function() {
            var e = this.option.toolbox
              ...
              , a = 0
              , o = 0;
            "horizontal" === e.orient ? (a = (n + i) * t - i,
            o = n) : (o = (n + i) * t - i,
            a = n);
            var r, s = this.zr.getWidth();
            switch (e.x) {
            case "center":
                r = Math.floor((s - a) / 2);
                break;
            case "left":
                r = e.padding[3] + e.borderWidth;
                break;
            case "right":
                r = s - a - e.padding[1] - e.borderWidth;
                break;
            default:
                r = e.x - 0,
                r = isNaN(r) ? 0 : r
            }
            var l, h = this.zr.getHeight();
            switch (e.y) {
            case "top":
                l = e.padding[0] + e.borderWidth;
                break;
            case "bottom":
                l = h - o - e.padding[2] - e.borderWidth;
                break;
            case "center":
                l = Math.floor((h - o) / 2);
                break;
        ...
        __onSaveAsImage: function() {
            ...
            a.innerHTML = '<img style="vertical-align:middle" src="' + i + '" title="' + (window.attachEvent && -1 === navigator.userAgent.indexOf("Opera") ? "右键->图片另存为" : e.lang ? e.lang[0] : "点击保存") + '"/>',
            n.appendChild(a),
        ...
        __onMagicType: function(e) {
            ...
            t === m ? this._magicType[c] = !1 : t === c && (this._magicType[m] = !1),
        ...
        getMagicOption: function() {
            ...
            this._magicType[m] || this._magicType[c])
                for (var n = 0, a = this.option.series.length; a > n; n++)
                    this._magicType[m] ? (this.option.series[n].stack = "_ECHARTS_STACK_KENER_2014_",
                    t = m) : this._magicType[c] && (this.option.series[n].stack = null ,
                    t = c),
        ...
        refresh: function(e) {
            ...
            e.toolbox.padding = this.reformCssArray(e.toolbox.padding),
            this.option = e,
            this.clear(!0),
    ...
    return t.prototype = {
        ...
        _buildBackground: function() {
            var e = this.titleOption.padding[0]
              ...
              , i = this.titleOption.padding[2]
              , n = this.titleOption.padding[3];
            this.shapeList.push(new a({
                zlevel: this._zlevelBase,
                hoverable: !1,
                style: {
                    x: this._itemGroupLocation.x - n,
                    y: this._itemGroupLocation.y - e,
                    width: this._itemGroupLocation.width + n + t,
                    height: this._itemGroupLocation.height + e + i,
        ...
        _getItemGroupLocation: function() {
            var e, t = this.titleOption.text, i = this.titleOption.subtext, n = this.getFont(this.titleOption.textStyle), a = this.getFont(this.titleOption.subtextStyle), o = Math.max(s.getTextWidth(t, n), s.getTextWidth(i, a)), r = s.getTextHeight(t, n) + ("" === i ? 0 : this.titleOption.itemGap + s.getTextHeight(i, a)), l = this.zr.getWidth();
            switch (this.titleOption.x) {
            case "center":
                e = Math.floor((l - o) / 2);
                break;
            case "left":
                e = this.titleOption.padding[3] + this.titleOption.borderWidth;
                break;
            case "right":
                e = l - o - this.titleOption.padding[1] - this.titleOption.borderWidth;
                break;
            default:
            ...
            case "top":
                h = this.titleOption.padding[0] + this.titleOption.borderWidth;
                break;
            case "bottom":
        ...
        refresh: function(e) {
            ...
            this.titleOption.textStyle = r.merge(this.titleOption.textStyle, this.ecTheme.textStyle),
            this.titleOption.subtextStyle = r.merge(this.titleOption.subtextStyle, this.ecTheme.textStyle)),
            this.clear(),
            this._buildShape()
        }
    },
...
define("echarts/component/tooltip", ["require", "./base", "../util/shape/Cross", "zrender/shape/Line", "zrender/shape/Rectangle", "../config", "../util/ecData", "zrender/config", "zrender/tool/event", "zrender/tool/area", "zrender/tool/color", "zrender/tool/util", "zrender/shape/Base", "../component"], function(e) {
    ...
    return t.prototype = {
        ...
        _style: function(e) {
            ...
            e.backgroundColor && (t.push("background-Color:" + c.toHex(e.backgroundColor)),
        ...
        _getNearestDataIndex: function(e, t) {
            ...
            for (var h, m, c = this.component.grid.getY(), l = t.getCoordByIndex(i); l > c && (h = l,
            l >= a); )
                m = l,
                l = t.getCoordByIndex(++i);
        ...
        _showAxisTrigger: function(e, t, i) {
            ...
            if (V) {
                ...
                for (var g = 0, y = l.length; y > g; g++)
                    ...
                    c += this._style(this.query(l[g], "tooltip")),
                    null  != l[g].stack && "xAxis" == V ? (h.unshift(l[g]),
                    m.unshift(g)) : (h.push(l[g]),
                    m.push(g)));
                ...
                f = [p, this.component.grid.getY(), p, this.component.grid.getYend()]) : (p = d.getX(this._event),
                u = this.subPixelOptimize(n.getCoordByIndex(i), this._axisLineWidth),
                f = [this.component.grid.getX(), u, this.component.grid.getXend(), u]),
            ...
            if (h.length > 0) {
                ...
                if ("function" == typeof a) {
                    ...
                    for (var g = 0, y = h.length; y > g; g++)
                        ...
                        b = h[g].data[i],
                        b = null  != b ? null  != b.value ? b.value : b : "-",
        ...
        _showPolarTrigger: function(e, t) {
            ...
            for (var h = this.option.polar[e].indicator[t].text, m = 0, c = o.length; c > m; m++)
                this._isSelected(o[m].name) && o[m].polarIndex === e && "axis" === this.deepQuery([o[m], this.option], "tooltip.trigger") && (a = this.query(o[m], "tooltip.showContent") || a,
                i = this.query(o[m], "tooltip.formatter") || i,
                n = this.query(o[m], "tooltip.position") || n,
                l += this._style(this.query(o[m], "tooltip")),
                r.push(o[m]),
                s.push(m));
            if (r.length > 0) {
                for (var p, u, V, U = [], m = 0, c = r.length; c > m; m++) {
                    ...
                    for (var g = 0, y = p.length; y > g; g++)
                        ...
                        V = null  != u.value[t].value ? u.value[t].value : u.value[t],
                        U.push({
                            seriesIndex: s[m],
                            seriesName: r[m].name || "",
                            series: r[m],
                ...
                if ("function" == typeof i)
                    ...
                    for (var m = 0, c = U.length; c > m; m++)
                        i = i.replace("{a" + m + "}", this._encodeHTML(U[m].seriesName)),
                    ...
                    for (var m = 1, c = U.length; c > m; m++)
                        i += "<br/>" + this._encodeHTML(U[m].name) + "<br/>",
        ...
        _showItemTrigger: function(e) {
            if (this._curTarget) {
                var t, i, n, a = l.get(this._curTarget, "series"), o = l.get(this._curTarget, "data"), r = l.get(this._curTarget, "dataIndex"), h = l.get(this._curTarget, "name"), m = l.get(this._curTarget, "value"), c = l.get(this._curTarget, "special"), p = l.get(this._curTarget, "special2"), u = "";
                if ("island" != this._curTarget._type) {
                    var V = e ? "axis" : "item";
                    this.option.tooltip.trigger === V && (t = this.option.tooltip.formatter,
                    i = this.option.tooltip.position),
                    this.query(a, "tooltip.trigger") === V && (n = this.query(a, "tooltip.showContent") || n,
                    t = this.query(a, "tooltip.formatter") || t,
                    i = this.query(a, "tooltip.position") || i,
                    u += this._style(this.query(a, "tooltip"))),
                    n = this.query(o, "tooltip.showContent") || n,
                    t = this.query(o, "tooltip.formatter") || t,
                    i = this.query(o, "tooltip.position") || i,
                    u += this._style(this.query(o, "tooltip"))
                } else
                    n = this.deepQuery([o, a, this.option], "tooltip.showContent"),
                    t = this.deepQuery([o, a, this.option], "tooltip.islandFormatter"),
                    i = this.deepQuery([o, a, this.option], "tooltip.islandPosition");
                "function" == typeof t ? (this._curTicket = (a.name || "") + ":" + r,
                this._tDom.innerHTML = t.call(this.myChart, {
                    seriesIndex: l.get(this._curTarget, "seriesIndex"),
                    seriesName: a.name || "",
                    series: a,
                    dataIndex: r,
                    data: o,
                    ...
                    4: p,
                    5: o,
                    6: l.get(this._curTarget, "seriesIndex"),
                    7: r
                }, this._curTicket, this._setContent)) : "string" == typeof t ? (this._curTicket = 0 / 0,
                t = t.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}"),
                t = t.replace("{a0}", this._encodeHTML(a.name || "")).replace("{b0}", this._encodeHTML(h)).replace("{c0}", m instanceof Array ? m : this.numAddCommas(m)),
                t = t.replace("{d}", "{d0}").replace("{d0}", c || ""),
                t = t.replace("{e}", "{e0}").replace("{e0}", l.get(this._curTarget, "special2") || ""),
                this._tDom.innerHTML = t) : (this._curTicket = 0 / 0,
                this._tDom.innerHTML = a.type === s.CHART_TYPE_RADAR && c ? this._itemFormatter.radar.call(this, a, h, m, c) : a.type === s.CHART_TYPE_EVENTRIVER ? this._itemFormatter.eventRiver.call(this, a, h, m, o) : "" + (null  != a.name ? this._encodeHTML(a.name) + "<br/>" : "") + ("" === h ? "" : this._encodeHTML(h) + " : ") + (m instanceof Array ? m : this.numAddCommas(m)) + (null  == c ? "" : " (" + c + ")")),
                this._axisLineShape.invisible && this._axisShadowShape.invisible || (this._axisLineShape.invisible = !0,
                this.zr.modShape(this._axisLineShape.id),
                ...
                this.dom.firstChild.appendChild(this._tDom),
                this.hasAppend = !0),
                this._show(i, d.getX(this._event) + 20, d.getY(this._event) - 20, u))
            }
        },
        _itemFormatter: {
        ...
        _styleAxisPointer: function(e, t, i, n, a, o, r, s) {
            if (e.length > 0) {
                var l, h, d = this.option.tooltip.axisPointer, m = d.type, c = {
                    line: {},
                    cross: {},
                    shadow: {}
                };
                for (var p in c)
                    c[p].color = d[p + "Style"].color,
                    c[p].width = d[p + "Style"].width,
                    c[p].type = d[p + "Style"].type;
                for (var u = 0, V = e.length; V > u; u++)
                    "axis" === this.deepQuery([e[u], this.option], "tooltip.trigger") && (l = e[u],
                    h = this.query(l, "tooltip.axisPointer.type"),
                    m = h || m,
                    h && (c[h].color = this.query(l, "tooltip.axisPointer." + h + "Style.color") || c[h].color,
                    c[h].width = this.query(l, "tooltip.axisPointer." + h + "Style.width") || c[h].width,
                    c[h].type = this.query(l, "tooltip.axisPointer." + h + "Style.type") || c[h].type));
                ...
                this.zr.modShape(this._axisLineShape.id)) : "cross" === m ? (this._axisCrossShape.style = {
                    brushType: "stroke",
                ...
                this.zr.modShape(this._axisCrossShape.id)) : "shadow" === m && ((null  == c.shadow.width || "auto" === c.shadow.width || isNaN(c.shadow.width)) && (c.shadow.width = o),
                t === n ? Math.abs(this.component.grid.getX() - t) < 2 ? (c.shadow.width /= 2,
                t = n += c.shadow.width / 2) : Math.abs(this.component.grid.getXend() - t) < 2 && (c.shadow.width /= 2,
                t = n -= c.shadow.width / 2) : i === a && (Math.abs(this.component.grid.getY() - i) < 2 ? (c.shadow.width /= 2,
                i = a += c.shadow.width / 2) : Math.abs(this.component.grid.getYend() - i) < 2 && (c.shadow.width /= 2,
                i = a -= c.shadow.width / 2)),
        ...
        __onmousemove: function(e) {
            ...
            !this._mousein) {
                ...
                if (t) {
                    ...
                    this._event.zrenderX = i,
                    this._event.zrenderY = n,
                    this._needAxisTrigger && this.component.grid && m.isInside(r, this.component.grid.getArea(), i, n) ? this._showingTicket = setTimeout(this._tryShow, this._showDelay) : this._needAxisTrigger && this.component.polar && -1 != this.component.polar.isInside([i, n]) ? this._showingTicket = setTimeout(this._tryShow, this._showDelay) : (!this._event.connectTrigger && this.messageCenter.dispatch(s.EVENT.TOOLTIP_OUT_GRID, this._event, null , this.myChart),
                    this._hidingTicket = setTimeout(this._hide, this._hideDelay))
            }
        },
...
define("echarts/component/legend", ["require", "./base", "zrender/shape/Text", "zrender/shape/Rectangle", "zrender/shape/Sector", "../util/shape/Icon", "../util/shape/Candle", "../config", "zrender/tool/util", "zrender/tool/area", "../component"], function(e) {
    ...
    t.prototype = {
        ...
        _buildItem: function() {
            ...
            for (var x = 0; p > x; x++)
                o = h.merge(c[x].textStyle || {}, u),
                s = this.getFont(o),
                e = this._getName(c[x]),
                l = this._getFormatterName(e),
                "" !== e ? (t = c[x].icon || this._getSomethingByName(e).type,
                m = this.getColor(e),
                "horizontal" === this.legendOption.orient ? 200 > V - g && f + 5 + d.getTextWidth(l, s) + (x === p - 1 || "" === c[x + 1] ? 0 : _) >= V - g && (g = this._itemGroupLocation.x,
                y += b + _) : 200 > U - y && b + (x === p - 1 || "" === c[x + 1] ? 0 : _) >= U - y && ("right" === this.legendOption.x ? g -= this._itemGroupLocation.maxWidth + _ : g += this._itemGroupLocation.maxWidth + _,
                y = this._itemGroupLocation.y),
                i = this._getItemShapeByType(g, y, f, b, this._selectedMap[e] ? m : "#ccc", t, m),
                i._name = e,
                i = new r(i),
                a = {
                    zlevel: this._zlevelBase,
                ...
                "horizontal" === this.legendOption.orient ? g += f + 5 + d.getTextWidth(l, s) + _ : y += b + _) : "horizontal" === this.legendOption.orient ? (g = this._itemGroupLocation.x,
                y += b + _) : ("right" === this.legendOption.x ? g -= this._itemGroupLocation.maxWidth + _ : g += this._itemGroupLocation.maxWidth + _,
                y = this._itemGroupLocation.y);
        ...
        _buildBackground: function() {
            var e = this.legendOption.padding[0]
              ...
              , i = this.legendOption.padding[2]
              , n = this.legendOption.padding[3];
            this.shapeList.push(new a({
                zlevel: this._zlevelBase,
                hoverable: !1,
                style: {
        ...
        _getItemGroupLocation: function() {
            ...
            if ("horizontal" === this.legendOption.orient) {
                l = a;
                for (var U = 0; t > U; U++)
                    "" !== this._getName(e[U]) ? u += n + d.getTextWidth(this._getFormatterNameFromData(e[U]), e[U].textStyle ? this.getFont(h.merge(e[U].textStyle || {}, o)) : r) + i : (u -= i,
                    u > c ? (s = c,
                    l += a + i) : s = Math.max(s, u),
                    l += a + i,
                    u = 0);
                l = Math.max(l, a),
                u -= i,
                ...
                s = V;
                for (var U = 0; t > U; U++)
                    "" !== this._getName(e[U]) ? u += a + i : (u -= i,
                    u > p ? (l = p,
                    s += V + i) : l = Math.max(l, u),
                    s += V + i,
                    u = 0);
                s = Math.max(s, V),
                u -= i,
            ...
            case "left":
                ...
                break;
            case "right":
                g = c - s - this.legendOption.padding[1] - this.legendOption.padding[3] - 2 * this.legendOption.borderWidth;
                break;
            default:
                g = this.parsePercent(this.legendOption.x, c)
            }
            var y;
            ...
            case "top":
                ...
                break;
            case "bottom":
                y = p - l - this.legendOption.padding[0] - this.legendOption.padding[2] - 2 * this.legendOption.borderWidth;
                break;
            case "center":
                y = Math.floor((p - l) / 2);
                break;
        ...
        _getItemShapeByType: function(e, t, i, n, a, o, r) {
            ...
            case "k":
                ...
                h.highlightStyle.lineWidth = 3,
                h.highlightStyle.color = h.style.color = this.query(this.ecTheme, "k.itemStyle.normal.color") || "#fff",
                h.style.strokeColor = "#ccc" != a ? this.query(this.ecTheme, "k.itemStyle.normal.lineStyle.color") || "#ff3200" : a;
                break;
            case "image":
                h.style.iconType = "image",
                h.style.image = s,
                "#ccc" === a && (h.style.opacity = .5)
            }
            return h
        },
        ...
        refresh: function(e) {
            if (e) {
                ...
                for (var s = 0, h = o.length; h > s; s++)
                    ...
                    i.series ? (a = !i.data || i.type !== l.CHART_TYPE_PIE && i.type !== l.CHART_TYPE_FORCE && i.type !== l.CHART_TYPE_FUNNEL ? [i.series] : [i.data, i.series],
                    ...
                    this._selectedMap[t] = "undefined" != typeof this._selectedMap[t] ? this._selectedMap[t] : !0) : this._selectedMap[t] = !1)
            }
            this.clear(),
            this._buildShape()
        },
...
define("zrender/tool/color", ["require", "../tool/util"], function(e) {
    ...
    function s(e, t, i, n, a, o, r) {
        F || (F = P.getContext());
        for (var s = F.createRadialGradient(e, t, i, n, a, o), l = 0, h = r.length; h > l; l++)
    ...
    function l(e, t, i, n, a) {
        F || (F = P.getContext());
        for (var o = F.createLinearGradient(e, t, i, n), r = 0, s = a.length; s > r; r++)
    ...
    function h(e, t, i) {
        ...
        for (var n = [], a = (t[0] - e[0]) / i, o = (t[1] - e[1]) / i, r = (t[2] - e[2]) / i, s = (t[3] - e[3]) / i, l = 0, h = e[0], d = e[1], c = e[2], p = e[3]; i > l; l++)
            n[l] = m([C(Math.floor(h), [0, 255]), C(Math.floor(d), [0, 255]), C(Math.floor(c), [0, 255]), p.toFixed(4) - 0], "rgba"),
            h += a,
            d += o,
            c += r,
            p += s;
    ...
    function p(e, t) {
        ...
        e.indexOf("hsb") > -1 ? i = A(i) : e.indexOf("hsl") > -1 && (i = z(i)),
        t.indexOf("hsb") > -1 || t.indexOf("hsv") > -1 ? i = J(i) : t.indexOf("hsl") > -1 && (i = O(i)),
        i[3] = n,
        m(i, t)
    }
    function u(e) {
    ...
    function S(e, t) {
        ...
        null  === t && (t = 1);
        var i = K(u(e));
        return i[3] = C(Number(t).toFixed(4), [0, 1]),
        m(i, "rgba")
    }
    function T(e, t) {
    ...
    var F, P = e("../tool/util"), D = ["#ff9277", " #dddd00", " #ffc877", " #bbe3ff", " #d5ffbb", "#bbbbff", " #ddb000", " #b0dd00", " #e2bbff", " #ffbbe3", "#ff7777", " #ff9900", " #83dd00", " #77e3ff", " #778fff", "#c877ff", " #ff77ab", " #ff6600", " #aa8800", " #77c7ff", "#ad77ff", " #ff77ff", " #dd0083", " #777700", " #00aa00", "#0088aa", " #8400dd", " #aa0088", " #dd0000", " #772e00"], N = D, H = "rgba(255,255,0,0.5)", R = H, B = /^\s*((#[a-f\d]{6})|(#[a-f\d]{3})|rgba?\(\s*([\d\.]+%?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+%?)?)\s*\)|hsba?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+)?)%?\s*\)|hsla?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+)?)%?\s*\))\s*$/i, G = {
        aliceblue: "#f0f8ff",
        antiquewhite: "#faebd7",
        aqua: "#0ff",
        aquamarine: "#7fffd4",
...
define("echarts/component/timeline", ["require", "./base", "zrender/shape/Rectangle", "../util/shape/Icon", "../util/shape/Chain", "../config", "zrender/tool/util", "zrender/tool/area", "zrender/tool/event", "../component"], function(e) {
    ...
    return t.prototype = {
        ...
        _getLocation: function() {
            var e, t = this.timelineOption, i = t.padding, n = this.zr.getWidth(), a = this.parsePercent(t.x, n), o = this.parsePercent(t.x2, n);
        ...
        _getChainPoint: function() {
            ...
            for (var g, y, f, b, _, x = [], U = 0; p > U; U++)
                ...
                f = !0) : f = !1,
                g.match("star") && (y = g.replace("star", "") - 0 || 5,
                g = "star"),
                t = h[U].textStyle ? l.merge(h[U].textStyle || {}, r) : r,
                b = t.align || "center",
                o ? (b = o > 0 ? "right" : "left",
                _ = [o * Math.PI / 180, d, m - 5]) : _ = !1,
                x.push({
                    x: d,
                    n: y,
                    isEmpty: f,
        ...
        setTheme: function(e) {
            ...
            this.timelineOption.label.textStyle = l.merge(this.timelineOption.label.textStyle || {}, this.ecTheme.textStyle),
            this.timelineOption.checkpointStyle.label.textStyle = l.merge(this.timelineOption.checkpointStyle.label.textStyle || {}, this.ecTheme.textStyle),
...
define("zrender/shape/Image", ["require", "./Base", "../tool/util"], function(e) {
    var t, i = [], n = e("./Base"), a = function(e) {
        n.call(this, e)
    }
    ;
    return a.prototype = {
        type: "image",
        brush: function(e, n, a) {
            var o = this.style || {};
            n && (o = this.getHighlightStyle(o, this.highlightStyle || {}));
            var r = o.image
              , s = this;
            if (this._imageCache || (this._imageCache = {}),
            "string" == typeof r) {
                var l = r;
                this._imageCache[l] ? r = this._imageCache[l] : (r = new Image,
                r.onload = function() {
                    r.onload = null ,
                    clearTimeout(t),
                    i.push(s),
                ...
                ,
                r.src = l,
                this._imageCache[l] = r)
            }
            if (r) {
                if ("IMG" == r.nodeName.toUpperCase())
                ...
                o.sWidth && o.sHeight) {
                    var p = o.sx || 0
                      , u = o.sy || 0;
                    e.drawImage(r, p, u, o.sWidth, o.sHeight, m, c, h, d)
                } else if (o.sx && o.sy) {
                    var p = o.sx
                      , u = o.sy
                      , V = h - p
                      , U = d - u;
                    e.drawImage(r, p, u, V, U, m, c, h, d)
                } else
                    e.drawImage(r, m, c, h, d);
                o.width || (o.width = h),
                o.height || (o.height = d),
                this.style.width || (this.style.width = h),
                this.style.height || (this.style.height = d),
    ...
    t.prototype._start = function(e, t) {
        ...
        return setInterval(function() {
            ...
            for (var i = 0; h > i; i++) {
                ...
                n.y - c[i].animationY + n.r <= 0 && (c[i].highlightStyle.y = u + n.r,
                c[i].highlightStyle.x = Math.ceil(Math.random() * p)),
    ...
    t.prototype._start = function(e, t) {
        ...
        return setInterval(function() {
            ...
            for (var i = 0; h > i; i++) {
                ...
                n.xStart >= c && (m[i].len = Math.ceil(400 * Math.random()),
                n.xStart = -400,
                n.xEnd = -400 + m[i].len,
...
define("zrender/loadingEffect/Ring", ["require", "./Base", "../tool/util", "../tool/color", "../shape/Ring", "../shape/Sector"], function(e) {
    ...
    t.prototype._start = function(e, t) {
        ...
        if (null  != i.progress) {
            ...
            e(g);
            for (var x = 0; 20 > x; x++)
                y[x].highlightStyle.color = k > x ? y[x]._color : U,
                e(y[x]);
            return e(h),
            void t()
        }
        return setInterval(function() {
            ...
            e(g);
            for (var i = 0; 20 > i; i++)
                y[i].highlightStyle.color = k > i ? y[i]._color : U,
                e(y[i]);
            e(h),
            t()
        }
...
define("zrender/dep/excanvas", ["require"], function() {
    return document.createElement("canvas").getContext ? G_vmlCanvasManager = !1 : !function() {
        ...
        function t(e, t) {
            ...
            return function() {
                return e.apply(t, i.concat(F.call(arguments)))
            }
        }
        function i(e) {
        ...
        function V(e) {
            ...
            "#" == e.charAt(0))
                ...
                for (var n, a = d(e), t = "#", o = 0; 3 > o; o++)
                    n = -1 != a[o].indexOf("%") ? Math.floor(255 * m(a[o])) : +a[o],
                    t += D[c(n, 0, 255)];
                i = +a[3]
            } else if (/^hsl/.test(e)) {
                var a = d(e);
        ...
        function k(e, t, i, n) {
            ...
            if (a instanceof w) {
                ...
                var O = V(e.fillStyle)
                  , F = O.color
                  , P = O.alpha * e.globalAlpha;
                t.push('<g_vml_:fill color="', F, '" opacity="', P, '" />')
            }
        }
        function L(e, t, i) {
            var n = e.m_;
            return {
                x: J * (t * n[0][0] + i * n[1][0] + n[2][0]) - O,
                y: J * (t * n[0][1] + i * n[1][1] + n[2][1]) - O
            }
        }
        function v(e) {
        ...
        var T = Math
          ...
          , J = 10
          , O = J / 2
          , F = (+navigator.userAgent.match(/MSIE ([\d.]+)?/)[1],
        ...
        for (var D = [], N = 0; 16 > N; N++)
            for (var H = 0; 16 > H; H++)
                D[16 * N + H] = N.toString(16) + H.toString(16);
        var R = {
            aliceblue: "#F0F8FF",
            antiquewhite: "#FAEBD7",
            aquamarine: "#7FFFD4",
        ...
        q.drawImage = function(e) {
            ...
            var p = L(this, t, i)
              ...
              , U = 10
              , g = f = 1;
            if (u.push(" <g_vml_:group", ' coordsize="', J * V, ",", J * U, '"', ' coordorigin="0,0"', ' style="width:', V, "px;height:", U, "px;position:absolute;"),
            1 != this.m_[0][0] || this.m_[0][1] || 1 != this.m_[1][1] || this.m_[1][0]) {
                var y = []
                  , g = this.scaleX_
                  , f = this.scaleY_;
                y.push("M11=", this.m_[0][0] / g, ",", "M12=", this.m_[1][0] / f, ",", "M21=", this.m_[0][1] / g, ",", "M22=", this.m_[1][1] / f, ",", "Dx=", C(p.x / J), ",", "Dy=", C(p.y / J), "");
                var b = p
                  , _ = L(this, t + n, i)
                  , x = L(this, t, i + a)
                  , k = L(this, t + n, i + a);
                b.x = T.max(b.x, _.x, x.x, k.x),
                b.y = T.max(b.y, _.y, x.y, k.y),
                u.push("padding:0 ", C(b.x / J), "px ", C(b.y / J), "px 0;filter:progid:DXImageTransform.Microsoft.Matrix(", y.join(""), ", SizingMethod='clip');")
            } else
                u.push("top:", C(p.y / J), "px;left:", C(p.x / J), "px;");
            u.push(' ">'),
...
define("zrender/Handler", ["require", "./config", "./tool/env", "./tool/event", "./tool/util", "./tool/vector", "./tool/matrix", "./mixin/Eventful"], function(e) {
    ...
    var o = e("./config")
      ...
      , u = {
            ...
            for (var o in n)
                if ("hover" !== o) {
                    ...
                    if (r.zoomable) {
                        ...
                        var h = r.__zoom;
                        h *= i,
                        h = Math.max(Math.min(r.maxZoom, h), r.minZoom),
                        i = h / r.__zoom,
                        r.__zoom = h,
                        l[0] -= (this._mouseX - l[0]) * (i - 1),
                        l[1] -= (this._mouseY - l[1]) * (i - 1),
                        r.scale[0] *= i,
                        r.scale[1] *= i,
                        r.dirty = !0,
                        a = !0,
        ...
        mousedown: function(e) {
            ...
            2 == this._lastDownButton ? (this._lastDownButton = e.button,
            void (this._mouseDownTarget = null )) : (this._lastMouseDownMoment = new Date,
            e = this._zrenderEventFixed(e),
            this._isMouseDown = 1,
            this._mouseDownTarget = this._lastHover,
            this._dispatchAgency(this._lastHover, m.MOUSEDOWN, e),
        ...
        touchend: function(e) {
            ...
            var t = new Date;
            t - this._lastTouchMoment < m.touchClickDelay && (this._mobildFindFixed(e),
            this._clickHandler(e),
            t - this._lastClickMoment < m.touchClickDelay / 2 && (this._dblclickHandler(e),
    ...
    V.prototype._processDrop = function(e) {
        ...
        this.painter.refresh(),
        this._dispatchAgency(this._lastHover, m.DROP, e, this._draggingTarget))
    }
    ,
    V.prototype._processDragEnd = function(e) {
        this._draggingTarget && (this._dispatchAgency(this._draggingTarget, m.DRAGEND, e),
        this._lastHover = null ),
        this._isDragging = 0,
...
define("zrender/Painter", ["require", "./config", "./tool/util", "./tool/log", "./tool/matrix", "./loadingEffect/Base", "./mixin/Transformable", "./shape/Image"], function(e) {
    ...
    function n(e, t, i) {
        ...
        n.style.width = a + "px",
        n.style.height = o + "px",
        n.setAttribute("width", a * d),
        n.setAttribute("height", o * d),
    ...
    var m = window.G_vmlCanvasManager
      , c = function(e, i) {
        ...
        this._zlevelList = [],
        this._layerConfig = {},
        this._loadingEffect = new l({}),
        this.shapeToImage = this._createShapeToImageProcessor(),
        this._bgDom = n("bg", "div", this),
        a.appendChild(this._bgDom),
    ...
    c.prototype._paintList = function(e, t) {
        ...
        for (var l in this._layers)
            "hover" !== l && (this._layers[l].unusedCount++,
            this._layers[l].updateTransform());
        for (var h = [], d = 0, c = e.length; c > d; d++) {
            var p = e[d];
            if (n !== p.zlevel && (i && (i.needTransform && o.restore(),
            o.flush && o.flush()),
            i = this.getLayer(p.zlevel),
            o = i.ctx,
            n = p.zlevel,
            i.unusedCount = 0,
            (i.dirty || t) && i.clear(),
            ...
            if ((i.dirty || t) && !p.invisible && (!p.onbrush || p.onbrush && !p.onbrush(o, !1)))
                if (a.catchBrushException)
                    try {
                        p.brush(o, !1, this.updatePainter)
                    } catch (U) {
                        r(U, "brush error of " + p.type, p)
                    }
                else
                    p.brush(o, !1, this.updatePainter);
            p.__stopClip && !m && o.restore(),
            p.__dirty = !1
        }
        ...
        for (var l in this._layers)
            if ("hover" !== l) {
                var g = this._layers[l];
                g.dirty = !1,
                1 == g.unusedCount && g.clear()
            }
    }
    ,
    c.prototype.getLayer = function(e) {
        ...
        if (!t) {
            ...
            this._zlevelList.splice(a + 1, 0, e),
            t = new p(e,this);
            var r = n ? n.dom : this._bgDom;
            r.nextSibling ? r.parentNode.insertBefore(t.dom, r.nextSibling) : r.parentNode.appendChild(t.dom),
            t.initContext(),
            this._layers[e] = t,
    ...
    c.prototype._updateLayerStatus = function(e) {
        ...
        for (var a = 0, o = e.length; o > a; a++) {
            ...
            if (l) {
                if (l.elCount++,
                l.dirty)
                    continue;l.dirty = r.__dirty
            }
        }
        for (var n in t)
            "hover" !== n && i[n] !== t[n].elCount && (t[n].dirty = !0)
    }
    ,
    ...
    c.prototype.toDataURL = function(e, t, i) {
        ...
        1 != d && s.scale(d, d),
        s.fillStyle = t || "#fff",
        s.rect(0, 0, this._width * d, this._height * d),
        s.fill();
        var l = this;
    ...
    c.prototype._brushHover = function(e) {
        ...
        if (!e.onbrush || e.onbrush && !e.onbrush(t, !0)) {
            ...
            a.catchBrushException)
                try {
                    e.brush(t, !0, this.updatePainter)
                } catch (n) {
    ...
    ;
    var p = function(e, i) {
        this.dom = n(e, "canvas", i),
        this.dom.onselectstart = t,
        this.dom.style["-webkit-user-select"] = "none",
        this.dom.style["user-select"] = "none",
        this.dom.style["-webkit-touch-callout"] = "none",
        m && m.initElement(this.dom),
        this.domBack = null ,
        this.ctxBack = null ,
        this.painter = i,
        this.unusedCount = 0,
    ...
    return p.prototype.initContext = function() {
        ...
        1 != d && this.ctx.scale(d, d)
    }
    ,
    p.prototype.createBackBuffer = function() {
        m || (this.domBack = n("back-" + this.id, "canvas", this.painter),
        this.ctxBack = this.domBack.getContext("2d"),
        1 != d && this.ctxBack.scale(d, d))
    }
    ,
    p.prototype.resize = function(e, t) {
        this.dom.style.width = e + "px",
        this.dom.style.height = t + "px",
        this.dom.setAttribute("width", e * d),
        this.dom.setAttribute("height", t * d),
        1 != d && this.ctx.scale(d, d),
        this.domBack && (this.domBack.setAttribute("width", e * d),
        this.domBack.setAttribute("height", t * d),
        1 != d && this.ctxBack.scale(d, d))
    }
    ,
    p.prototype.clear = function() {
        ...
        this.ctxBack.drawImage(e, 0, 0, i / d, n / d)),
        a ? (t.save(),
        t.fillStyle = this.config.clearColor,
        t.fillRect(0, 0, i / d, n / d),
        t.restore()) : t.clearRect(0, 0, i / d, n / d),
        o) {
            var s = this.domBack;
            t.save(),
            t.globalAlpha = r,
            t.drawImage(s, 0, 0, i / d, n / d),
            t.restore()
        }
    }
    ,
    o.merge(p.prototype, h.prototype),
    c
}
),
    ...
    o.prototype.mod = function(e, t) {
        ...
        t))
            if (t.parent || t._storage || t.__startClip) {
                var a = {};
                for (var o in t)
                    "parent" != o && "_storage" != o && "__startClip" != o && t.hasOwnProperty(o) && (a[o] = t[o]);
                i.merge(n, a, !0)
            } else
                i.merge(n, t, !0);
        return this
                ...
                if (U) {
                    ...
                    if (U) {
                        ...
                        for (var x = [], k = [], L = 0; U > L; L++) {
                            x.push(u[L].time / _);
                            var v = u[L].value;
                            "string" == typeof v && (v = m.toArray(v),
                            0 === v.length && (v[0] = v[1] = v[2] = 0,
                            v[3] = 1),
                            f = !0),
                            k.push(v)
                        }
                            ...
                            if (0 !== d) {
                                ...
                                c)
                                    ...
                                    y)
                                        ...
                                        var m;
                                        f ? (m = r(X, I, K, S, w, w * w, w * w * w, E, 1),
                                        m = h(E)) : m = s(X, I, K, S, w, w * w, w * w * w),
                                        i(e, V, m)
                                    }
                                else if (y)
...
define("zrender/mixin/Transformable", ["require", "../tool/matrix", "../tool/vector"], function(e) {
    ...
    return s.prototype = {
        ...
        updateTransform: function() {
            if (this.updateNeedTransform(),
            this.needTransform = this.parent ? this.needLocalTransform || this.parent.needTransform : this.needLocalTransform,
            this.needTransform) {
                ...
                this.needLocalTransform) {
                    ...
                    if (this.rotation instanceof Array) {
                        ...
                        0 !== this.rotation && n.rotate(e, e, this.rotation);
                    (i(this.position[0]) || i(this.position[1])) && n.translate(e, e, this.position)
                }
                this.transform = e,
                this.parent && this.parent.needTransform && (this.needLocalTransform ? n.mul(this.transform, this.parent.transform, this.transform) : n.copy(this.transform, this.parent.transform))
            }
        },
        ...
        lookAt: function() {
            ...
            return function(i) {
                ...
                a.sub(e, i, this.position),
                t(e[0]) && t(e[1]) || (a.normalize(e, e),
...
define("zrender/tool/area", ["require", "./util", "./curve"], function(e) {
    ...
    function y(e, t, i, n, a, o, r, s, l, h) {
        ...
        for (var m, c, p = 0, u = -1, V = 0; d > V; V++) {
            ...
            l > y || (0 > u && (u = W.cubicExtrema(t, n, o, s, E),
            E[1] < E[0] && u > 1 && g(),
            m = W.cubicAt(t, n, o, s, E[0]),
            u > 1 && (c = W.cubicAt(t, n, o, s, E[1]))),
            p += 2 == u ? U < E[0] ? t > m ? 1 : -1 : U < E[1] ? m > c ? 1 : -1 : c > s ? 1 : -1 : U < E[0] ? t > m ? 1 : -1 : m > s ? 1 : -1)
        }
        return p
    }
        ...
        for (var m = 0, c = 0; 2 > c; c++) {
            ...
            if (p + e > s) {
                var u = Math.atan2(l, p)
                  , d = r ? 1 : -1;
                0 > u && (u = T + u),
                (u >= a && o >= u || u + T >= a && o >= u + T) && (u > Math.PI / 2 && u < 1.5 * Math.PI && (d = -d),
                m += d)
            }
        }
        return m
    ...
    function _(e, t, i, n, a) {
        ...
        for (var g = "stroke" === i || "both" === i, _ = "fill" === i || "both" === i, x = 0; x < e.length; x++) {
            ...
            case "A":
                ...
                p = T) : o += U(d, m, S, T);
                var C = (n - v) * X / w + v;
                if (g && h(v, W, X, I, I + K, 1 - L[7], t, C, a))
                    return !0;
                _ && (o += b(v, W, X, I, I + K, 1 - L[7], C, a)),
                d = Math.cos(I + K) * w + v,
                m = Math.sin(I + K) * X + W;
                break;
            case "z":
...
define("zrender/shape/Base", ["require", "../tool/matrix", "../tool/guid", "../tool/util", "../tool/log", "../mixin/Transformable", "../mixin/Eventful", "../tool/area", "../tool/color"], function(e) {
    ...
    d.prototype.getTansform = function() {
        ...
        return function(t, i) {
            var n = [t, i];
            return this.needTransform && this.transform && (a.invert(e, this.transform),
            a.mulVector(n, e, [t, i, 1]),
            t == n[0] && i == n[1] && this.updateNeedTransform()),
            n
        }
    }
    (),
    ...
    d.prototype.isCover = function(t, i) {
        ...
        return a || (a = this.style.__rect = this.getRect(this.style)),
        t >= a.x && t <= a.x + a.width && i >= a.y && i <= a.y + a.height ? e("../tool/area").isInside(this, this.style, t, i) : !1
    }
    ,
    d.prototype.drawText = function(e, i, n) {
        if ("undefined" != typeof i.text && i.text !== !1) {
            ...
            case "end":
                ...
                h -= 4,
                c != p ? s -= "end" == o ? h : -h : o = "center",
                u != V ? l -= "bottom" == r ? h : -h : r = "middle";
                break;
            case "specific":
                s = i.textX || 0,
                l = i.textY || 0,
...
define("zrender/tool/curve", ["require", "./vector"], function(e) {
        ...
        if (t(m) && t(c))
            ...
            if (t(y)) {
                ...
                var _ = Math.sqrt(y)
                  , x = m * l + 1.5 * s * (-c + _)
                  , k = m * l + 1.5 * s * (-c - _);
                x = 0 > x ? -Math.pow(-x, g) : Math.pow(x, g),
                k = 0 > k ? -Math.pow(-k, g) : Math.pow(k, g);
                var V = (-l - (x + k)) / (3 * s);
                V >= 0 && 1 >= V && (r[u++] = V)
            } else {
    ...
    function l(e, t, i, a, o, r, s, l, h, d, m) {
        ...
        for (var x = 0; 32 > x && !(V > p); x++) {
            ...
            if (k >= 0 && U > _)
                ...
                b[0] = n(e, i, o, s, L),
                b[1] = n(t, a, r, l, L);
                var v = u.distSquare(b, y);
                1 >= L && U > v ? (c = L,
                U = v) : p *= .5
            }
        }
        return m && (m[0] = n(e, i, o, s, c),
        m[1] = n(t, a, r, l, c)),
        Math.sqrt(U)
    }
    function h(e, t, i, n) {
    ...
    function p(e, t, i, n, a, o, r, s, l) {
        ...
        for (var p = 0; 1 > p; p += .05) {
            f[0] = h(e, i, a, p),
            f[1] = h(t, n, o, p);
            var U = u.distSquare(y, f);
            c > U && (d = p,
            c = U)
        }
        c = 1 / 0;
        for (var g = 0; 32 > g && !(V > m); g++) {
            var _ = d - m
              , x = d + m;
            f[0] = h(e, i, a, _),
            f[1] = h(t, n, o, _);
            var U = u.distSquare(f, y);
            if (_ >= 0 && c > U)
                d = _,
                c = U;
            else {
...
define("zrender/Group", ["require", "./tool/guid", "./tool/util", "./mixin/Transformable", "./mixin/Eventful"], function(e) {
    ...
    o.prototype.addChildrenToStorage = function(e) {
        for (var t = 0; t < this._children.length; t++) {
            ...
            e.addToMap(i),
            "group" === i.type && i.addChildrenToStorage(e)
        }
    }
    ,
    o.prototype.delChildrenFromStorage = function(e) {
        for (var t = 0; t < this._children.length; t++) {
            var i = this._children[t];
            e.delFromMap(i.id),
            "group" === i.type && i.delChildrenFromStorage(e)
        }
    }
    ,
        ...
        s._onlegendhoverlink = function(e) {
            if (s.legendHoverLink)
                for (var t, a = e.target, o = s.shapeList.length - 1; o >= 0; o--)
                    ...
                    t != a || s.shapeList[o].invisible || s.zr.addHoverShape(s.shapeList[o])
        }
        ,
        ...
        this.shapeHandler = {
            ...
            ondragover: function(t) {
                ...
                var n = i.highlightStyle
                  ...
                  , r = n.lineWidth;
                n.brushType = "stroke",
                n.strokeColor = e.ecTheme.calculableColor,
                n.lineWidth = "icon" === i.type ? 30 : 10,
                e.zr.addHoverShape(i),
                setTimeout(function() {
                    i.highlightStyle && (i.highlightStyle.brushType = a,
                    i.highlightStyle.strokeColor = o,
                    i.highlightStyle.lineWidth = r)
                }
                , 20)
            },
            ondrop: function(t) {
    ...
    return t.prototype = {
        ...
        ondrop: function(e, t) {
            if (this.isDrop && e.target && !t.dragIn) {
                ...
                if (-1 === l) {
                    ...
                    for (var c = !1, p = h[o].data, u = 0, V = p.length; V > u; u++)
                        p[u].name === i.name && "-" === p[u].value && (h[o].data[u].value = i.value,
                        c = !0);
                    !c && h[o].data.push(i),
                    m && m.add(i.name, a.style.color || a.style.strokeColor)
                } else
                    i = this.option.series[o].data[l] || "-",
                    null  != i.value ? (this.option.series[o].data[l].value = "-" != i.value ? d.accAdd(this.option.series[o].data[l].value, s.get(a, "value")) : s.get(a, "value"),
                    (this.type === r.CHART_TYPE_FUNNEL || this.type === r.CHART_TYPE_PIE) && (m && 1 === m.getRelatedAmount(i.name) && this.component.legend.del(i.name),
                    i.name += this.option.nameConnector + s.get(a, "name"),
                    m && m.add(i.name, a.style.color || a.style.strokeColor))) : this.option.series[o].data[l] = "-" != i ? d.accAdd(this.option.series[o].data[l], s.get(a, "value")) : s.get(a, "value");
                t.dragIn = t.dragIn || !0,
                this.isDrop = !1;
                var U = this;
                setTimeout(function() {
        ...
        _bulidPosition: function() {
            ...
            for (var e, t, i, n, a = this.series, o = {
                ...
                right: [],
                other: []
            }, s = 0, l = a.length; l > s; s++)
                a[s].type === this.type && (a[s] = this.reformOption(a[s]),
                this.legendHoverLink = a[s].legendHoverLink || this.legendHoverLink,
                e = a[s].xAxisIndex,
                t = a[s].yAxisIndex,
                i = this.component.xAxis.getAxis(e),
                n = this.component.yAxis.getAxis(t),
                i.type === r.COMPONENT_TYPE_AXIS_CATEGORY ? o[i.getPosition()].push(s) : n.type === r.COMPONENT_TYPE_AXIS_CATEGORY ? o[n.getPosition()].push(s) : o.other.push(s));
            for (var h in o)
        ...
        _mapData: function(e) {
            for (var t, i, n, a, o = this.series, s = 0, l = {}, h = "__kener__stack__", d = this.component.legend, m = [], c = 0, p = 0, u = e.length; u > p; p++)
                t = o[e[p]],
                n = t.name,
                this._sIndex2ShapeMap[e[p]] = this._sIndex2ShapeMap[e[p]] || this.query(t, "symbol") || this._symbol[p % this._symbol.length],
                d ? (this.selectedMap[n] = d.isSelected(n),
                this._sIndex2ColorMap[e[p]] = d.getColor(n),
                a = d.getItemShape(n),
                a && (this.type == r.CHART_TYPE_LINE ? (a.style.iconType = "legendLineIcon",
                a.style.symbol = this._sIndex2ShapeMap[e[p]]) : t.itemStyle.normal.barBorderWidth > 0 && (a.style.x += 1,
                a.style.y += 1,
                a.style.width -= 2,
                a.style.height -= 2,
                a.style.strokeColor = a.highlightStyle.strokeColor = t.itemStyle.normal.barBorderColor,
                a.highlightStyle.lineWidth = 3,
                a.style.brushType = "both"),
                d.setItemShape(n, a))) : (this.selectedMap[n] = !0,
                this._sIndex2ColorMap[e[p]] = this.zr.getColor(e[p])),
                this.selectedMap[n] && (i = t.stack || h + e[p],
                null  == l[i] ? (l[i] = s,
                m[s] = [e[p]],
                s++) : m[l[i]].push(e[p])),
            ...
            for (var n = this.series, a = 0, o = t.length; o > a; a++)
                for (var r = 0, s = t[a].length; s > r; r++) {
                    ...
                    if ("-1" != i.indexOf("x")) {
                        ...
                        e[l]["averageLine" + h] = [[d, this.component.grid.getYend()], [d, this.component.grid.getY()]],
                        e[l]["minLine" + h] = [[e[l]["minX" + h], this.component.grid.getYend()], [e[l]["minX" + h], this.component.grid.getY()]],
                        e[l]["maxLine" + h] = [[e[l]["maxX" + h], this.component.grid.getYend()], [e[l]["maxX" + h], this.component.grid.getY()]],
                        e[l].isHorizontal = !1
                    }
                    if (h = "xy" == i ? 1 : "",
                    "-1" != i.indexOf("y")) {
                        ...
                        e[l]["averageLine" + h] = [[this.component.grid.getX(), m], [this.component.grid.getXend(), m]],
                        e[l]["minLine" + h] = [[this.component.grid.getX(), e[l]["minY" + h]], [this.component.grid.getXend(), e[l]["minY" + h]]],
                        e[l]["maxLine" + h] = [[this.component.grid.getX(), e[l]["maxY" + h]], [this.component.grid.getXend(), e[l]["maxY" + h]]],
                        e[l].isHorizontal = !0
                    }
                }
        },
        addLabel: function(e, t, i, n, a) {
            var o = [i, t]
              ...
              , l = r.textStyle || {}
              , h = s.textStyle || {};
            return r.show && (e.style.text = this._getLabelText(t, i, n, "normal"),
            e.style.textPosition = null  == r.position ? "horizontal" === a ? "right" : "top" : r.position,
            e.style.textColor = l.color,
            e.style.textFont = this.getFont(l)),
            s.show && (e.highlightStyle.text = this._getLabelText(t, i, n, "emphasis"),
            e.highlightStyle.textPosition = r.show ? e.style.textPosition : null  == s.position ? "horizontal" === a ? "right" : "top" : s.position,
            e.highlightStyle.textColor = h.color,
            e.highlightStyle.textFont = this.getFont(h)),
            e
        },
        _getLabelText: function(e, t, i, n) {
            ...
            return a ? "function" == typeof a ? a.call(this.myChart, e.name, i, o) : "string" == typeof a ? (a = a.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}"),
            a = a.replace("{a0}", e.name).replace("{b0}", i).replace("{c0}", this.numAddCommas(o))) : void 0 : this.numAddCommas(o)
        },
        buildMark: function(e) {
            var t = this.series[e];
            this.selectedMap[t.name] && (t.markPoint && this._buildMarkPoint(e),
            t.markLine && this._buildMarkLine(e))
        },
        _buildMarkPoint: function(e) {
            for (var t, i, n = (this.markAttachStyle || {})[e], a = this.series[e], o = this.getZlevelBase(), s = m.clone(a.markPoint), l = 0, h = s.data.length; h > l; l++)
                t = s.data[l],
                i = this.getMarkCoord(e, t),
                s.data[l].x = null  != t.x ? t.x : i[0],
                s.data[l].y = null  != t.y ? t.y : i[1],
                !t.type || "max" !== t.type && "min" !== t.type || (s.data[l].value = i[3],
                s.data[l].name = t.name || t.type,
                s.data[l].symbolSize = s.data[l].symbolSize || c.getTextWidth(i[3], this.getFont()) / 2 + 5);
            ...
            if (this.type === r.CHART_TYPE_FORCE || this.type === r.CHART_TYPE_CHORD)
                for (var l = 0, h = d.length; h > l; l++)
                    this.zr.addShape(d[l])
        },
        _buildMarkLine: function(e) {
            for (var t, i, n = (this.markAttachStyle || {})[e], a = this.series[e], o = this.getZlevelBase(), s = m.clone(a.markLine), l = 0, h = s.data.length; h > l; l++)
                t = s.data[l],
                !t.type || "max" !== t.type && "min" !== t.type && "average" !== t.type ? i = [this.getMarkCoord(e, t[0]), this.getMarkCoord(e, t[1])] : (i = this.getMarkCoord(e, t),
                s.data[l] = [m.clone(t), {}],
                s.data[l][0].name = t.name || t.type,
                s.data[l][0].value = i[3],
                i = i[2],
                t = [{}, {}]),
                null  != i && null  != i[0] && null  != i[1] && (s.data[l][0].x = null  != t[0].x ? t[0].x : i[0][0],
                s.data[l][0].y = null  != t[0].y ? t[0].y : i[0][1],
                s.data[l][1].x = null  != t[1].x ? t[1].x : i[1][0],
                s.data[l][1].y = null  != t[1].y ? t[1].y : i[1][1]);
        ...
        _markPoint: function(e, t) {
            var i = this.series[e]
              , n = this.component;
            m.merge(t, this.ecTheme.markPoint),
            t.name = i.name;
            var a, o, l, h, d, c, p, u = [], V = t.data, U = n.dataRange, g = n.legend, y = this.zr.getWidth(), f = this.zr.getHeight();
            if (t.large)
                ...
                for (var b = 0, _ = V.length; _ > b; b++)
                    null  != V[b].x && null  != V[b].y && (l = null  != V[b] && null  != V[b].value ? V[b].value : "",
                    g && (o = g.getColor(i.name)),
                    U && (o = isNaN(l) ? o : U.getColor(l),
                    h = [V[b], t],
                    d = this.deepQuery(h, "itemStyle.normal.color") || o,
                    c = this.deepQuery(h, "itemStyle.emphasis.color") || d,
                    null  == d && null  == c) || (o = null  == o ? this.zr.getColor(e) : o,
                    V[b].tooltip = V[b].tooltip || t.tooltip || {
                        trigger: "item"
                    },
                    V[b].name = null  != V[b].name ? V[b].name : "",
                    V[b].value = l,
                    a = this.getSymbolShape(t, e, V[b], b, V[b].name, this.parsePercent(V[b].x, y), this.parsePercent(V[b].y, f), "pin", o, "rgba(0,0,0,0)", "horizontal"),
                    a._mark = "point",
                    p = this.deepMerge([V[b], t], "effect"),
                    p.show && (a.effect = p),
                    i.type === r.CHART_TYPE_MAP && (a._geo = this.getMarkGeo(V[b])),
                    s.pack(a, i, e, V[b], b, V[b].name, l),
                    u.push(a)));
            return u
        },
        _markLine: function(e, t) {
            var i = this.series[e]
              , n = this.component;
            m.merge(t, this.ecTheme.markLine),
            ...
            t.name = i.name;
            for (var a, o, l, h, d, c, p, u, V = [], U = t.data, g = n.dataRange, y = n.legend, f = this.zr.getWidth(), b = this.zr.getHeight(), _ = 0, x = U.length; x > _; _++)
                null  != U[_][0].x && null  != U[_][0].y && null  != U[_][1].x && null  != U[_][1].y && (o = y ? y.getColor(i.name) : this.zr.getColor(e),
                u = this.deepMerge(U[_]),
                l = null  != u && null  != u.value ? u.value : "",
                g && (o = isNaN(l) ? o : g.getColor(l),
                h = [u, t],
                d = this.deepQuery(h, "itemStyle.normal.color") || o,
                c = this.deepQuery(h, "itemStyle.emphasis.color") || d,
                null  == d && null  == c) || (U[_][0].tooltip = u.tooltip || {
                    trigger: "item"
                },
                U[_][0].name = null  != U[_][0].name ? U[_][0].name : "",
                U[_][1].name = null  != U[_][1].name ? U[_][1].name : "",
                U[_][0].value = null  != U[_][0].value ? U[_][0].value : "",
                a = this.getLineMarkShape(t, e, U[_], _, this.parsePercent(U[_][0].x, f), this.parsePercent(U[_][0].y, b), this.parsePercent(U[_][1].x, f), this.parsePercent(U[_][1].y, b), o),
                a._mark = "line",
                p = this.deepMerge([u, t], "effect"),
                p.show && (a.effect = p),
                i.type === r.CHART_TYPE_MAP && (a._geo = [this.getMarkGeo(U[_][0]), this.getMarkGeo(U[_][1])]),
                s.pack(a, i, e, U[_][0], _, U[_][0].name + ("" !== U[_][1].name ? " > " + U[_][1].name : ""), l),
                V.push(a)));
            return V
        },
        ...
        getSymbolShape: function(e, t, a, o, r, l, h, d, m, c, p) {
            ...
            var x = new n({
                style: {
                    ...
                    height: 2 * U,
                    brushType: "both",
                    color: d.match("empty") ? c : this.getItemStyleColor(y.color, t, o, a) || m,
                    strokeColor: y.borderColor || this.getItemStyleColor(y.color, t, o, a) || m,
                    lineWidth: b
                },
                highlightStyle: {
                    color: d.match("empty") ? c : this.getItemStyleColor(f.color, t, o, a),
                    strokeColor: f.borderColor || y.borderColor || this.getItemStyleColor(y.color, t, o, a) || m,
                    lineWidth: _
                },
                clickable: this.deepQuery(u, "clickable")
            });
            return d.match("image") && (x.style.image = d.replace(new RegExp("^image:\\/\\/"), ""),
            x = new i({
                style: x.style,
                highlightStyle: x.highlightStyle,
                clickable: this.deepQuery(u, "clickable")
            })),
            null  != g && (x.rotation = [g * Math.PI / 180, l, h]),
            d.match("star") && (x.style.iconType = "star",
            x.style.n = d.replace("empty", "").replace("star", "") - 0 || 5),
            "none" === d && (x.invisible = !0,
            x.hoverable = !1),
            x = this.addLabel(x, e, a, r, p),
            d.match("empty") && (null  == x.style.textColor && (x.style.textColor = x.style.strokeColor),
            null  == x.highlightStyle.textColor && (x.highlightStyle.textColor = x.highlightStyle.strokeColor)),
            s.pack(x, e, t, a, o, r),
            x._x = l,
            x._y = h,
            x._dataIndex = o,
        ...
        getLineMarkShape: function(e, t, i, n, o, r, s, l, h) {
            ...
            p[0] = "function" == typeof p[0] ? p[0](d) : p[0],
            p[1] = "function" == typeof p[1] ? p[1](m) : p[1];
            ...
            g.color = this.getItemStyleColor(g.color, t, n, i);
            var y = U.lineStyle
              , f = g.lineStyle
              , b = y.width;
            null  == b && (b = U.borderWidth);
            var _ = f.width;
            null  == _ && (_ = null  != g.borderWidth ? g.borderWidth : b + 2);
            var x = new a({
                style: {
                    ...
                    brushType: "both",
                    lineType: y.type,
                    shadowColor: y.shadowColor || y.color || U.borderColor || U.color || h,
                    shadowBlur: y.shadowBlur,
                    shadowOffsetX: y.shadowOffsetX,
                    shadowOffsetY: y.shadowOffsetY,
                    color: U.color || h,
                    strokeColor: y.color || U.borderColor || U.color || h,
                    lineWidth: b,
                ...
                highlightStyle: {
                    ...
                    color: g.color || U.color || h,
                    strokeColor: f.color || y.color || g.borderColor || U.borderColor || g.color || U.color || h,
                    lineWidth: _,
                    symbolBorderColor: g.borderColor || U.borderColor || g.color || U.color || h,
                    symbolBorder: null  == g.borderWidth ? U.borderWidth + 2 : g.borderWidth
                },
                clickable: this.deepQuery(V, "clickable")
            });
            return x = this.addLabel(x, e, i[0], i[0].name + " : " + i[1].name),
            x._x = s,
            x._y = l,
            x
        },
        getLargeMarkPoingShape: function(e, t) {
            ...
            !c || (a = null  != m[0] ? null  != m[0].value ? m[0].value : m[0] : "-",
            n = isNaN(a) ? n : c.getColor(a),
            r = this.deepQuery(u, "itemStyle.normal.color") || n,
            s = this.deepQuery(u, "itemStyle.emphasis.color") || r,
            null  != r || null  != s)) {
        ...
        addShapeList: function() {
            ...
            if (this.option.animation && !this.option.renderAsImage && a.length < i && !this.motionlessOnce) {
                for (var d = 0, m = n.length; m > d; d++)
                    t = this._getAnimationKey(n[d]),
                    t.match("undefined") ? this.zr.delShape(n[d].id) : (t += n[d].type,
                    l[t] = n[d]);
                for (var d = 0, m = a.length; m > d; d++)
                    t = this._getAnimationKey(a[d]),
                    t.match("undefined") ? this.zr.addShape(a[d]) : (t += a[d].type,
                    h[t] = a[d]);
                for (t in l)
                    h[t] || this.zr.delShape(l[t].id);
                for (t in h)
                    l[t] ? (this.zr.delShape(l[t].id),
                    this._animateMod(l[t], h[t], o, s)) : (e = this.type != r.CHART_TYPE_LINE && this.type != r.CHART_TYPE_RADAR || 0 == t.indexOf("icon") ? 0 : o / 2,
                    this._animateMod(!1, h[t], o, s, e));
                this.zr.refresh(),
        ...
        animationMark: function(e, t, i) {
            for (var n = i || this.shapeList, a = 0, o = n.length; o > a; a++)
                n[a]._mark && this._animateMod(!1, n[a], e, t);
        ...
        animationEffect: function(e) {
            ...
            for (var n, a = 0, o = t.length; o > a; a++)
                n = t[a],
                n._mark && n.effect && n.effect.show && h[n._mark] && (h[n._mark](this.zr, this.effectList, n, i),
...
define("echarts/util/ecQuery", [], function() {
    ...
    function i(t, i) {
        for (var a, o = t.length; o--; ) {
            var r = e(t[o], i);
            "undefined" != typeof r && ("undefined" == typeof a ? a = n.clone(r) : n.merge(a, r, !0))
        }
        return a
    }
    var n = require("zrender/tool/util");
    return {
        query: e,
        deepQuery: t,
        deepMerge: i
...
define("echarts/util/shape/Icon", ["require", "zrender/tool/util", "zrender/shape/Star", "zrender/shape/Heart", "zrender/shape/Droplet", "zrender/shape/Image", "zrender/shape/Base"], function(e) {
    ...
    function p(e, t) {
        for (var i = t.x, n = t.y, a = t.width, o = t.height, r = Math.round(o / 3), s = 3; s--; )
            e.rect(i, n + r * s + 2, a, 2)
    }
    function u(e, t) {
        for (var i = t.x, n = t.y, a = t.width, o = t.height, r = Math.round(a / 3), s = 3; s--; )
            e.rect(i + r * s, n, 2, o)
    }
    function V(e, t) {
        var i = t.x
    ...
    return X.prototype = {
        ...
        brush: function(t, i, n) {
            ...
            if ("image" === o) {
                ...
                var s = e("zrender/shape/Base");
                s.prototype.brush.call(this, t, i, n)
            }
        },
        buildPath: function(e, t) {
            this.iconLibrary[t.iconType] ? this.iconLibrary[t.iconType](e, t) : (e.moveTo(t.x, t.y),
            e.lineTo(t.x + t.width, t.y),
            e.lineTo(t.x + t.width, t.y + t.height),
            e.lineTo(t.x, t.y + t.height),
            e.lineTo(t.x, t.y),
    ...
    return t.prototype = {
            ...
            if (t.lineType && "solid" != t.lineType) {
                if ("dashed" == t.lineType || "dotted" == t.lineType)
                    if ("spline" !== t.smooth) {
                        ...
                        for (var o = 1; n > o; o++)
                            d(e, i[o - 1][0], i[o - 1][1], i[o][0], i[o][1], a)
                    } else
                        for (var o = 1; n > o; o += 2)
                            e.moveTo(i[o - 1][0], i[o - 1][1]),
                            e.lineTo(i[o][0], i[o][1])
            } else {
                e.moveTo(i[0][0], i[0][1]);
                for (var o = 1; n > o; o++)
                    e.lineTo(i[o][0], i[o][1])
        ...
        brushSymbol: function(e, t, i) {
            if ("none" != t.symbol[i]) {
                ...
                t.iconType = t.symbol[i].replace("empty", "").toLowerCase(),
        ...
        buildArrawPath: function(e, t, i) {
            ...
            var m = Math.PI / 8
              , c = 0 === i ? o : r
              , p = 0 === i ? s : l
              , u = [[c + a * Math.cos(d - m), p - a * Math.sin(d - m)], [c + .6 * a * Math.cos(d), p - .6 * a * Math.sin(d)], [c + a * Math.cos(d + m), p - a * Math.sin(d + m)]];
            e.moveTo(c, p);
            for (var V = 0, U = u.length; U > V; V++)
                e.lineTo(u[V][0], u[V][1]);
            e.lineTo(c, p)
        },
        ...
        getOffetPoint: function(e, t) {
            ...
            if (e[0] != t[0] && e[1] != t[1]) {
                ...
                i = e[0] == t[0] ? (e[1] <= t[1] ? 1 : -1) * Math.PI / 2 : 0;
            var s, l;
            return e[0] <= t[0] ? (i -= o,
            s = Math.round(Math.cos(i) * n),
            l = Math.round(Math.sin(i) * n),
            a[0] += s,
            a[1] += l) : (i += o,
            s = Math.round(Math.cos(i) * n),
            l = Math.round(Math.sin(i) * n),
        ...
        isCover: function(e, t) {
            ...
            t = i[1];
            var n = this.style.__rect;
            return n || (n = this.style.__rect = this.getRect(this.style)),
            e >= n.x && e <= n.x + n.width && t >= n.y && t <= n.y + n.height ? "spline" !== this.style.smooth ? h.isInside(o, this.style, e, t) : h.isInside(s, this.style, e, t) : !1
        }
    },
    c.inherits(t, i),
    t
...
define("echarts/util/ecAnimation", ["require", "zrender/tool/util", "zrender/shape/Polygon"], function(e) {
    ...
    function o(e, t, i, n, a) {
        ...
        e.animate(i.id, "").when(Math.round(n / 3 * 2), {
            rotation: [0, o, r]
    ...
    function p(e, t, i, n, a) {
        i.style.smooth ? t ? e.addShape(i) : (i.style.pointListLength = 1,
        e.addShape(i),
        i.style.pointList = i.style.pointList || i.getPointList(i.style),
        e.animate(i.id, "style").when(n, {
            pointListLength: i.style.pointList.length
        }).start(a || "QuinticOut")) : (i.style.pointList = t ? t.style.pointList : [[i.style.xStart, i.style.yStart], [i.style.xStart, i.style.yStart]],
        e.addShape(i),
        e.animate(i.id, "style").when(n, {
            pointList: [[i.style.xStart, i.style.yStart], [i._x || 0, i._y || 0]]
        }).start(a || "QuinticOut"))
    }
...
define("echarts/util/ecEffect", ["require", "../util/ecData", "zrender/shape/Circle", "zrender/shape/Image", "../util/shape/Icon", "../util/shape/Symbol", "zrender/tool/env"], function(e) {
    function t(e, t, i, n) {
        ...
        h && (p.style.image = e.shapeToImage(p, p.style.width + 2 * c + 2, p.style.height + 2 * c + 2).style.image,
        p = new r({
            zlevel: p.zlevel,
            style: p.style,
            draggable: !1,
        ...
        p.style.x = i.style._x - V,
        p.style.y = i.style._y - V;
        var U = 100 * (o.period + 10 * Math.random());
        e.modShape(i.id, {
            invisible: !0
        });
        var g = p.style.x + p.style.width / 2 / u
          , y = p.style.y + p.style.height / 2 / u;
        e.modShape(p.id, {
            scale: [.1, .1, g, y]
        }),
    ...
    function n(e, t, i, n) {
        ...
        h ? (u.style.image = e.shapeToImage(u, 2 * (c + p), 2 * (c + p)).style.image,
        u = new r({
            zlevel: u.zlevel,
            style: u.style,
            draggable: !1,
        ...
        t.push(u),
        e.addShape(u),
        u.style.x = i.style.xStart - s,
        u.style.y = i.style.yStart - s;
        ...
        if (i.style.smooth) {
            var g = i.style.pointList || i.getPointList(i.style)
              , y = g.length;
            U = Math.round(U / y);
            for (var f = e.animate(u.id, "style", l.loop), b = Math.ceil(y / 8), _ = 0; y - b > _; _ += b)
                f.when(U * (_ + 1), {
                    x: g[_][0] - s,
                    y: g[_][1] - s
                });
            ...
            e.animate(u.id, "style", l.loop).when(U, {
                x: i._x - s,
                y: i._y - s
            }).done(function() {
                i.effect.show = !1,
        ...
        buildPath: function(e, t) {
            ...
            if (!(o.length < 2)) {
                ...
                if (t.smooth && "spline" !== t.smooth) {
                    ...
                    for (var l, h, d, m = 0; r - 1 > m; m++)
                        l = s[2 * m],
                        h = s[2 * m + 1],
                        d = o[m + 1],
                        e.bezierCurveTo(l[0], l[1], h[0], h[1], d[0], d[1])
                } else if ("spline" === t.smooth && (o = i(o),
                r = o.length),
...
define("zrender/shape/Polygon", ["require", "./Base", "./util/smoothSpline", "./util/smoothBezier", "./util/dashedLineTo", "../tool/util"], function(e) {
    ...
    return o.prototype = {
        ...
        brush: function(e, t) {
            ...
            this.setTransform(e);
            var n = !1;
            ("fill" == i.brushType || "both" == i.brushType || "undefined" == typeof i.brushType) && (e.beginPath(),
            "dashed" == i.lineType || "dotted" == i.lineType ? (this.buildPath(e, {
                lineType: "solid",
                lineWidth: i.lineWidth,
                pointList: i.pointList
            }),
            n = !1) : (this.buildPath(e, i),
            n = !0),
            e.closePath(),
            e.fill()),
            i.lineWidth > 0 && ("stroke" == i.brushType || "both" == i.brushType) && (n || (e.beginPath(),
            this.buildPath(e, i)),
            e.stroke()),
            this.drawText(e, i, this.style),
            e.restore()
...
define("echarts/component/dataView", ["require", "./base", "../config", "zrender/tool/util", "../component"], function(e) {
    ...
    return t.prototype = {
        ...
        show: function(e) {
            ...
            this._textArea.value = "function" != typeof i ? this._optionToContent() : i(this.option),
            ...
            this._textArea.style.cursor = "default") : (this._textArea.readOnly = !0,
        ...
        _optionToContent: function() {
                ...
                a = s.length; a > e; e++)
                    if ("category" == (s[e].type || "category")) {
                        ...
                        i = s[e].data.length; i > t; t++)
                            o = s[e].data[t],
                            r.push("undefined" != typeof o.value ? o.value : o);
                        l += r.join(", ") + "\n\n"
                    }
            ...
            a = d.length; a > e; e++) {
                ...
                i = d[e].data.length; i > t; t++)
                    ...
                    d[e].type == n.CHART_TYPE_SCATTER && (o = "undefined" != typeof o.value ? o.value : o,
                    o = o.join(", ")),
                    r.push(h + ("undefined" != typeof o.value ? o.value : o));
                l += (d[e].name || "-") + " : \n",
        ...
        _contentToOption: function(e) {
            ...
            o = m.length; o > t; t++)
                if (d++,
                m[t].type == n.CHART_TYPE_SCATTER)
                    for (var i = 0, a = m[t].data.length; a > i; i++)
                        s = e[d],
                        l = s.replace(" ", "").split(","),
                        "undefined" != typeof m[t].data[i].value ? m[t].data[i].value = l : m[t].data[i] = l,
                        d++;
                else {
                    s = e[d].split(",");
                    for (var i = 0, a = m[t].data.length; a > i; i++)
...
define("zrender/shape/Sector", ["require", "../tool/math", "../tool/computeBoundingBox", "../tool/vector", "./Base", "../tool/util"], function(e) {
    ...
    return h.prototype = {
        ...
        getRect: function(e) {
            ...
            return u || (c = -c,
            p = -p),
            d > 1 ? i.arc(a, h, d, c, p, !u, o, s) : (o[0] = s[0] = a,
            o[1] = s[1] = h),
    ...
    return t.prototype = {
        ...
        axisBase: {
            _buildAxisLine: function() {
                ...
                "" !== this.option.name && (i.style.text = this.option.name,
                i.style.textPosition = this.option.nameLocation,
                i.style.textFont = this.getFont(this.option.nameTextStyle),
                this.option.nameTextStyle.align && (i.style.textAlign = this.option.nameTextStyle.align),
                this.option.nameTextStyle.baseline && (i.style.textBaseline = this.option.nameTextStyle.baseline),
                this.option.nameTextStyle.color && (i.style.textColor = this.option.nameTextStyle.color)),
                i.style.strokeColor = this.option.axisLine.lineStyle.color,
                i.style.lineWidth = e,
                this.isHorizontal() ? i.style.yStart = i.style.yEnd = this.subPixelOptimize(i.style.yEnd, e) : i.style.xStart = i.style.xEnd = this.subPixelOptimize(i.style.xEnd, e),
                i.style.lineType = this.option.axisLine.lineStyle.type,
                i = new n(i),
                this.shapeList.push(i)
            },
    ...
    return t.prototype = {
        ...
        _backupData: function() {
            ...
            for (var s, l = this.option.series, h = this._zoom.seriesIndex, i = 0, n = h.length; n > i; i++)
                ...
                s.data && s.data[0] && s.data[0] instanceof Array && (s.type == r.CHART_TYPE_SCATTER || s.type == r.CHART_TYPE_LINE || s.type == r.CHART_TYPE_BAR) && (this._backupScale(),
        ...
        _buildBackground: function() {
            ...
            for (var c, p = this._zoom.seriesIndex[0], u = this._originalData.series[p], V = Number.MIN_VALUE, U = Number.MAX_VALUE, l = 0, h = u.length; h > l; l++)
                c = null  != u[l] ? null  != u[l].value ? u[l].value : u[l] : 0,
            ...
            for (var l = 0, h = i; h > l; l += _)
                ...
                this.option.series[p].type == r.CHART_TYPE_K && (c = c[1]),
                isNaN(c) && (c = 0),
                y.push("horizontal" == this.zoomOption.orient ? [this._location.x + f * l, this._location.y + t - 1 - Math.round((c - U) / g * (t - 10))] : [this._location.x + 1 + Math.round((c - U) / g * (e - 10)), this._location.y + b * l]);
            "horizontal" == this.zoomOption.orient ? (y.push([this._location.x + e, this._location.y + t]),
            y.push([this._location.x, this._location.y + t])) : (y.push([this._location.x, this._location.y + t]),
        ...
        _syncHandleShape: function() {
            ...
            this._zoom.end = Math.ceil((this._endShape.style.x + this._handleSize - this._location.x) / this._location.width * 100)) : (this._startShape.style.y = this._fillerShae.style.y - this._handleSize,
            this._endShape.style.y = this._fillerShae.style.y + this._fillerShae.style.height,
        ...
        _syncFillerShape: function() {
            ...
            this._zoom.start = Math.floor((Math.min(e, t) - this._location.x) / this._location.width * 100),
            this._zoom.end = Math.ceil((Math.max(e, t) + this._handleSize - this._location.x) / this._location.width * 100)) : (e = this._startShape.style.y,
            ...
            this._zoom.start = Math.floor((Math.min(e, t) - this._location.y) / this._location.height * 100),
            this._zoom.end = Math.ceil((Math.max(e, t) + this._handleSize - this._location.y) / this._location.height * 100)),
        ...
        _syncFrameShape: function() {
            ...
            this._endFrameShape.style.width = this._location.x + this._location.width - this._endFrameShape.style.x) : (this._startFrameShape.style.height = this._fillerShae.style.y - this._location.y,
        ...
        _syncShape: function() {
            ...
            this._fillerShae.style.width = this._endShape.style.x - this._startShape.style.x - this._handleSize) : (this._startShape.style.y = this._location.y + this._zoom.start / 100 * this._location.height,
        ...
        _syncData: function(e) {
            ...
            for (var s in this._originalData) {
                ...
                for (var l in t)
                    ...
                    this.option[s][l].data[0] instanceof Array && this.option[s][l].type != r.CHART_TYPE_K ? (this._setScale(),
        ...
        _getDetail: function() {
            ...
            if ("time" == d) {
                c = m + p * this._zoom.end / 100,
                m += p * this._zoom.start / 100;
...
define("echarts/component/categoryAxis", ["require", "./base", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Rectangle", "../config", "zrender/tool/util", "zrender/tool/area", "../component"], function(e) {
    ...
    return t.prototype = {
        ...
        _buildAxisTick: function() {
            ...
            if (this.isHorizontal())
                for (var m, c = "bottom" == this.option.position ? i.inside ? this.grid.getYend() - n - 1 : this.grid.getYend() + 1 : i.inside ? this.grid.getY() + 1 : this.grid.getY() - n - 1, p = d; t > p; p += s)
                    m = this.subPixelOptimize(this.getCoordByIndex(p) + (p >= 0 ? h : 0), r),
                    e = {
                        _axisShape: "axisTick",
                        zlevel: this._zlevelBase,
                        hoverable: !1,
                ...
                for (var u, V = "left" == this.option.position ? i.inside ? this.grid.getX() + 1 : this.grid.getX() - n - 1 : i.inside ? this.grid.getXend() - n - 1 : this.grid.getXend() + 1, p = d; t > p; p += s)
                    u = this.subPixelOptimize(this.getCoordByIndex(p) - (p >= 0 ? h : 0), r),
                    e = {
                        _axisShape: "axisTick",
                        zlevel: this._zlevelBase,
                        hoverable: !1,
        ...
        _buildAxisLabel: function() {
            ...
            if (this.isHorizontal()) {
                var d, m;
                "bottom" == this.option.position ? (d = this.grid.getYend() + r,
                m = "top") : (d = this.grid.getY() - r,
                m = "bottom");
                for (var c = 0; a > c; c += this._interval)
                    "" !== this._getReformedLabel(c) && (t = s.merge(i[c].textStyle || {}, h),
                    e = {
                        zlevel: this._zlevelBase,
                        hoverable: !1,
                        style: {
                    ...
                    o && (e.style.textAlign = o > 0 ? "bottom" == this.option.position ? "right" : "left" : "bottom" == this.option.position ? "left" : "right",
                    e.rotation = [o * Math.PI / 180, e.style.x, e.style.y]),
                    this.shapeList.push(new n(this._axisLabelClickable(l, e))))
            } else {
                var p, u;
                "left" == this.option.position ? (p = this.grid.getX() - r,
                u = "right") : (p = this.grid.getXend() + r,
                u = "left");
                for (var c = 0; a > c; c += this._interval)
                    "" !== this._getReformedLabel(c) && (t = s.merge(i[c].textStyle || {}, h),
                    e = {
                    ...
                    o && (e.rotation = [o * Math.PI / 180, e.style.x, e.style.y]),
                    this.shapeList.push(new n(this._axisLabelClickable(l, e))))
            }
        },
        _buildSplitLine: function() {
            ...
            if (t -= l || "undefined" == typeof l && this.option.boundaryGap ? 1 : 0,
            this.isHorizontal())
                for (var d, m = this.grid.getY(), c = this.grid.getYend(), p = 0; t > p; p += this._interval)
                    d = this.subPixelOptimize(this.getCoordByIndex(p) + h, o),
                    e = {
                        zlevel: this._zlevelBase,
                        hoverable: !1,
                        style: {
                ...
                for (var u, V = this.grid.getX(), U = this.grid.getXend(), p = 0; t > p; p += this._interval)
                    u = this.subPixelOptimize(this.getCoordByIndex(p) - h, o),
                    e = {
                        zlevel: this._zlevelBase,
                        hoverable: !1,
                        style: {
        ...
        _buildSplitArea: function() {
            ...
            if (i instanceof Array) {
                ...
                if (this.isHorizontal())
                    for (var l, h = this.grid.getY(), d = this.grid.getHeight(), m = this.grid.getX(), c = 0; a >= c; c += this._interval)
                        l = a > c ? this.getCoordByIndex(c) + s : this.grid.getXend(),
                        e = {
                            zlevel: this._zlevelBase,
                            hoverable: !1,
                            style: {
                    ...
                    for (var p, u = this.grid.getX(), V = this.grid.getWidth(), U = this.grid.getYend(), c = 0; a >= c; c += this._interval)
                        p = a > c ? this.getCoordByIndex(c) - s : this.grid.getY(),
                        e = {
                            zlevel: this._zlevelBase,
                            hoverable: !1,
                            style: {
        ...
        refresh: function(e) {
            ...
            this.option.axisLabel.textStyle = s.merge(this.option.axisLabel.textStyle || {}, this.ecTheme.textStyle)),
            this.clear(),
            this._buildShape()
        },
        getGap: function() {
        ...
        getCoord: function(e) {
            for (var t = this.option.data, i = t.length, n = this.getGap(), a = this.option.boundaryGap ? n / 2 : 0, o = 0; i > o; o++) {
                if (t[o] == e || "undefined" != typeof t[o].value && t[o].value == e)
        ...
        getIndexByName: function(e) {
            for (var t = this.option.data, i = t.length, n = 0; i > n; n++)
                if (t[n] == e || "undefined" != typeof t[n].value && t[n].value == e)
                    return n;
            return -1
        },
    ...
    return t.prototype = {
        ...
        _buildAxisTick: function() {
            ...
            if (this.isHorizontal())
                ...
                for (var m, c = "left" === this.option.position ? n.inside ? this.grid.getX() + 1 : this.grid.getX() - o - 1 : n.inside ? this.grid.getXend() - o - 1 : this.grid.getXend() + 1, d = 0; i > d; d++)
                    m = this.subPixelOptimize(this.getCoord(t[d]), s),
                    e = {
                        _axisShape: "axisTick",
                        zlevel: this._zlevelBase,
                        hoverable: !1,
        ...
        _buildAxisLabel: function() {
            ...
            if (this.isHorizontal()) {
                ...
                var m, c;
                "left" === this.option.position ? (m = this.grid.getX() - o,
                c = "right") : (m = this.grid.getXend() + o,
                c = "left");
                for (var d = 0; i > d; d++)
                    e = {
                        zlevel: this._zlevelBase,
        ...
        _buildSplitLine: function() {
            ...
            if (this.isHorizontal())
                for (var h, d = this.grid.getY(), m = this.grid.getYend(), c = 0; i > c; c++)
                    h = this.subPixelOptimize(this.getCoord(t[c]), r),
                    e = {
                        zlevel: this._zlevelBase,
                        hoverable: !1,
                        style: {
                ...
                for (var p, u = this.grid.getX(), V = this.grid.getXend(), c = 0; i > c; c++)
                    p = this.subPixelOptimize(this.getCoord(t[c]), r),
                    e = {
                        zlevel: this._zlevelBase,
                        hoverable: !1,
                        style: {
            ...
            if (t instanceof Array) {
                ...
                if (this.isHorizontal())
                    ...
                    for (var m, c = this.grid.getX(), p = this.grid.getWidth(), u = this.grid.getYend(), d = 0; a >= d; d++)
                        m = a > d ? this.getCoord(n[d]) : this.grid.getY(),
                        e = {
                            zlevel: this._zlevelBase,
                            hoverable: !1,
                            style: {
        ...
        _calculSum: function(e, t) {
            ...
            if (this.series[t].stack) {
                ...
                for (var h = 0, d = n.length; d > h; h++)
                    i = null  != n[h].value ? n[h].value : n[h],
                    "-" !== i && (i -= 0,
...
define("echarts/util/smartSteps", [], function() {
    ...
    function i(e, t, i, a) {
        ...
        e > t && (t = [e, e = t][0]);
        var o = t - e;
        return 0 === o ? h(e, t, i) : (i || 5) > o && e === U(e) && t === U(t) ? d(e, t, i) : n(e, t, i)
    }
    function n(e, i, n, l) {
        u = u || (l || {}).steps || p;
        var h, d = n || c[c.length - 1], V = s(i - e), y = V.n;
        V = V.c,
        h = s(V / d, u),
        h.n < 0 && (y += h.n,
        V *= t(-h.n),
        ...
        if (n ? o(b) : a(b),
        e === U(e) && i === U(i) && (h = b.step * f,
        b.exp < 0 && h !== U(h) && e * i >= 0 && (h = g(h),
        V = h * b.secs,
        i - e > V && (h += 1,
        V = h * b.secs),
        V >= i - e))) {
        ...
        var x = m(e, i, b.min, b.max);
        return r(x[0], x[1], b.secs, b.exp)
    }
    function a(e) {
        for (var t, i, n, a, o = e.secs, r = e.step, l = e.step * o, h = c.length - 1; h--; )
            o = c[h],
            a = s(e.span / o, u).d,
            t = g(e.zmin / a) * a,
            i = y(e.zmax / a) * a,
    ...
    function o(e) {
        for (var t, i, n = e.zmax, a = e.step; n > e.zmin; )
            i = a * e.secs,
            t = y(e.zmax / a) * a,
            n = t - i,
            a = s(1.01 * a, u).d;
    ...
    function r(e, i, n, a) {
        a = a || 0;
        for (var o = t(a), r = (i - e) / n, s = 0, h = [], d = n + 1; d--; )
            h[d] = (e + r * d) * o;
        if (0 > a) {
            s = l(o),
            r = +(r * o).toFixed(s),
