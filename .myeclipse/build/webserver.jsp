...
<body>
	...
	<div class="col-xs-3 col-md-2" id="myScrollspy">
        <ul class="nav nav-tabs nav-stacked" data-spy="affix" data-offset-top="125">         
            ...
            <li><a href="cloudstore.jsp">云存储服务器</a></li>
            <li><a href="cloudgate.jsp">云存储网关</a></li>
            <li class="active"><a href="webserver.jsp">Web服务器</a></li>
            <li><a href="iotgate.jsp">物联网网关</a></li>
            <li><a href="bdyiti.jsp">数采大数据一体机</a></li>
            <!-- <li></li> -->
        </ul>
	...
	<div class="content col-md-10">
		<div class="container">
			<h2 align="center">Web服务器HaiWebSv</h2>				
		</div>
		<div class="container">
			<h3>产品功能：</h3>
			<p>1.实现数采数据从大数据一体机输出到该数采Web服务器；<br>
				2.实现数采数据从该数采Web服务器传输到用户和云网关；<br>
				3.实现用户终端通过Web服务器控制云终端的现场设备。<br>
			</p>
		...
		<div class="container">
			<h3>产品特色：</h3>
			<p>1.数采大数据分析结果的Web服务。<br>
				2.所有网关经过现场终端、物联网网关、云存储、大数据分析、Web服务、用户终端的严格试验测试、校准测试。<br>
				3.自主研发，有能力接受客户定制。<br>
			</p>
			...
			<table class="table table-bordered">
			   ...
			   <tbody>
			      ...
			      <tr>
			         ...
			         <td>8G*8条
					DDR3 ECC   24个插槽 最大768G（最高2133 MT/s）
					</td>
			      </tr>
			      <tr>
			         <td>磁盘存储</td>
			      ...
			      <tr>
			         ...
			         <td>集成Matrox G200 (16MB)</td>
			      </tr>
			      <tr>
			         <td>网口</td>
			         <td>2个千兆网口，intel 82576网卡芯片</td>
			         <td>4个1 Gb端口，2个1 Gb+2个10 Gb端口，4个10 Gb端口
					</td>
			      </tr>
			      <tr>
			         <td>电源</td>
			         <td>单电源 750W原装 电源支持热插拔及冗余</td>
			         <td>1100w热插拔PSU(可选冗余)</td>
			      </tr>
			      <tr>
			         <td>兼容系统</td>
			         <td>Microsoft Windows Server Red Hat Enterprise Linux (RHEL) SUSE Linux Enterprise Server (SLES) VMware</td>
			         <td>Microsoft Windows Server Red Hat Enterprise Linux (RHEL) SUSE Linux Enterprise Server (SLES) VMware
					</td>
			      </tr>
			      <tr>
			         <td>应用软件</td>
			         <td>HaiWebSvSoft1.0</td>
			         <td>HaiWebSvSoft2.0
					</td>
			      </tr>
