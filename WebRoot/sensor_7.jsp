...
<body>
	...
	<%@ include file="sidebar7.jsp" %>   
	
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
       	<ul class="nav nav-tabs" role="tablist">
       		<li role="presentation"><a href="console_7.jsp">实时数据信息</a></li>
       		<li role="presentation"><a href="history_7.jsp" >历史数据信息</a></li>
       		<li role="presentation"  class="active" ><a href="sensor_7.jsp">节点管理</a></li>
       	</ul>
    		...
    		<div class="recontrol">
    			<div>
     				<label>反馈控制(采样率设置) &nbsp;&nbsp;</label>
     				<select id="idState"  name="state" onchange="recontrol(7,this.value);"> 
						<option value="010" selected>10s</option> 
						<option value="030">30s</option> 
    		...
    		<form action="history_7.jsp" method="post" name="dateform">
     		<div style="height:50%">
     			...
     			<table class="table table-striped">
     				...
     				<tbody>
       				<%
						...
						ResultSet rs=stat.executeQuery("select * from sensor where node_id=7;");
					...
					%>
							...
							<tr id="colume_<%=sensor_id %>">
						          ...
						          <td><%
						          		...
						          		%>
						          		<div class="switch">
										    <input disabled="disabled" type="checkbox" checked id="switch_ckeckbox_<%=sensor_id %>"  onchange="switch_sensor(<%=sensor_id%>,<%=switch_state %>)"  /><!-- 动态绑定传感器数据和对应的编辑控件 -->
										</div>        		
						          		<%
						          		}
						          		else
