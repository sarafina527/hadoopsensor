	...
	<div class="content col-md-10">
		...
		<div class="container">
			<div class="col-lg-6">
                ...
                <p>基本功能、特点</p>
                <p>★WiFi部分</p>
                <p>☆支持无线802.11 b/g/n 标准</p>
                <p>☆支持STA/AP/STA+AP 三种工作模式</p>
                <p>☆内置TCP/IP协议栈</p>
                <p>☆支持UART/GPIO数据通信接口</p>
                <p>☆超低能耗，适合电池供电应用</p>
                <p>☆3.3V 单电源供电</p>
                <p>★支持无线入网，与远程物联大数据平台连接；</p>
                ...
                <p>★支持多路TCP Client连接；</p>
                <p>★支持远程固件升级（OTA）；</p>
                <p>★内置ZigBee 接收模块，智能自组网，一只网关可
                    带多个自组网节点一起工作。</p>
                    <br>
                <h4>特色功能：</h4>
                <p>★与远程物联大数据平台无缝连接；</p>
            ...
            <div class="col-lg-6">
                <img src="img/cp6-2pic0.png" alt=""  width="70%" />
                <h4>技术参数：</h4>
                <img src="img/cp6-2pic1.png" alt=""  />
            </div>
            

            <div class="col-lg-12">
                <h4>WiFi网关HaiLinkw产品选型：</h4>
                <img src="img/cp6-2pic3.png" alt=""  />
