...
<body>
	...
	<div class="col-xs-3 col-md-2" id="myScrollspy">
        <ul class="nav nav-tabs nav-stacked" data-spy="affix" data-offset-top="125">         
            <li><a href="datacollect.jsp">数据采集仪</a></li>
            <li class="active"><a href="board.jsp">开发板</a></li>
            <li><a href="cloudstore.jsp">云存储服务器</a></li>
            <li><a href="cloudgate.jsp">云存储网关</a></li>
            <li><a href="webserver.jsp">Web服务器</a></li>
            <li><a href="iotgate.jsp">物联网网关</a></li>
	...
	<div class="content col-md-10">
		...
		<div class="container">
			<h3>三、HaiSmartIII:带信号调理和放大器的开发板</h3>
			<h4>核心功能：</h4>
			<p>•	直径20mm<br>
				•	ATMega 328p处理器<br>
				•	串口转WiFi/GPRS<br>
				•	配置电荷放大器,可以直接接电荷型输入<br>
				•	配置恒流源,可以直接接ICP型传感器信号<br>
				•	ZIGBEE转串口转WiFi<br>
				•	PWM 灯光调节控制接口板<br>
				•	Onboard LED <br>
				•	三路传感器接口板：温湿度、光照<br>
