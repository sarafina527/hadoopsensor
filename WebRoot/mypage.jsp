		...
		<div class="project-wrapper">
			<div class="grid">
				...
				<div class="app-editor j_step">
					<div class="editor-title clearfix">
						<form class="editor-title-buttons j_preview" action="./"
						...
						<div class="editor-main">
							<div class="editor-canvas">
								...
								<div class="editor-canvas-grid"
									style="height: 800px; width: 1000px; background-color: rgb(255, 255, 255);">
								</div>
								<!--画布-->
			...
			<div class="app-save j_step hide">
				<form id="saveForm" class="form-horizontal" method="post"
					...
					<div class="form-group">
						<label>应用状态：</label> <input type="hidden" name="status" value="10"
							required=""> <a class="hollow button j_status"
							data-value="10">公开应用</a> <a class="secondary button j_status"
							data-value="20">私有应用</a>
					</div>
