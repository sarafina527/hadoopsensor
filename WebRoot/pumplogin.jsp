...
<html>
	...
	<body style="background:url(media/pic/shui.jpg) no-repeat;background-size:cover; font-family:Microsoft Yahei;" >
		...
		<div class="row"  style="position:absolute;top:25%;left:10%;right:15%">
			...
			<div class="col-md-2">
			 ...
			 <div class="col-md-4">
					  <form action="pumplogin" name="loginform" method="post" id="loginform">
