        		...
        		<div role="tabpanel" class="tab-pane fade active" id="node_info">
					...
					<h3>节点信息管理</h3>						
						...
						<%
							...
							ResultSet rs2=stat2.executeQuery("SELECT site FROM nodeinfo where node_id=02 and id = (select max(id) from nodeinfo where node_id=02);");
							String site = "未设置";
							while(rs2.next())
							{
									...
									datasets : [
										{
											...
											data : [
						<%
											rs=stat.executeQuery("select * from tb_sensorinfo_2 order by id desc limit 50;");
											double light=0.0;
											while(rs.next())
											{
