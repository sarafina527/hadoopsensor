...
<body>
  ...
  <div id="header">
    ...
    <div id="body">
    	<div>
        	<a href="index.jsp"><div class="buttondefault" id="t_r_t_d" onclick="winshow1()">实时数据</div></a>
            ...
            <div class="pumpword">泵</div>
      		<div class="pump_num">
        	<select id="pumpnumber" onchange="onchanged()" > 
      ...
      <div class="h_d_top">
    	 <form action="history.jsp" method="get" name="dateform">
...
<%
  ...
  if(PageNo != 1){
    ...
    %>
     <td>
     <% 
    out.print("<a href=history.jsp?PageNo=1&start="+stdate+"&end="+enddate+">首页 </a>");
    %>
    </td>
    <td>
    <%
    out.print("<a href=history.jsp?PageNo="+PrevStart+"&start="+stdate+"&end="+enddate+"><上一页</a>");
  }
   ...
   if(c <MaxPage){
     ...
     <td>
     <% 
        out.print("<a href=history.jsp?PageNo="+c+"&start="+stdate+"&end="+enddate+">"+c+"</a>");
     }else{
     %>
     </td>
     <td>
...
if(PageNo < MaxPage){ //如果当前页不是最后一页，则显示下一页链接
    ...
    <td>
    <%
    out.print("<a href=history.jsp?PageNo="+NextPage+"&start="+stdate+"&end="+enddate+">下一页></a>");
}
...
if(PageNo < MaxPage){
   ...
   <td>
	<% 
    out.print("<a href=history.jsp?PageNo="+MaxPage+"&start="+stdate+"&end="+enddate+">尾页</a>");
  }
  %>
  </td>
