      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="console_1.jsp"><a href="console_1.jsp">节点一</a></li>
        	...
        	<div class="tab-content">
        		<div role="tabpanel" class="tab-pane fade in active" id="table">
					...
					<%
							...
							ResultSet rs=stat.executeQuery("select * from tb_sensorinfo_7 order by id desc limit 50;");
									...
									datasets : [
										{
											...
											data : [
						<%
											rs=stat.executeQuery("select * from tb_sensorinfo_7 order by id desc limit 50;");
											double light=0.0;
											while(rs.next())
											{
