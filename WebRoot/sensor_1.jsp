...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
       	<ul class="nav nav-tabs" role="tablist">
       		...
       		<li role="presentation"  class="active" ><a href="sensor_1.jsp">节点管理</a></li>
       	</ul>
     
      	
    		<h3>节点传感器信息</h3>
    		<form action="history_1.jsp" method="post" name="dateform">
     		<div style="height:50%">
				...
				%>
							...
							<tr id="colume_<%=sensor_id %>">
						          ...
						          <td><%=location %></td>
						          <!-- <td>
						          		<SELECT id="idState" style="width:150" name="state" onchange="recontrol(<%=node_id%>,<%=sensor_id%>,this.value);"> 
