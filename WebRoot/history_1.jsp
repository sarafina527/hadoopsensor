...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
       	<ul class="nav nav-tabs" role="tablist">
     		...
     		<!-- 查询表单 -->
     	<form action="history_1.jsp" method="get" name="dateform">
		 	...
		 	<div class="col-md-12">
		 		 <div class="bs-example">
					...
					<%
							...
							String sql = "select * from tb_sensorinfo_1 where DATE(date) between '"+stdate+"' and '"+enddate+"' order by id desc limit 50;";
