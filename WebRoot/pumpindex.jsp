 ...
 <script src="http://echarts.baidu.com/build/dist/echarts.js"></script>
  ...
  <div id="header">
    ...
    <div id="body">
    	<div>
            ...
            <div class="open_close">
                ...
                <div class="open_close_pic"><img id="oc" src="imageswpf/open.png" class="open_close_pic"  onclick="stateChange()"/img></div>
   ...
   <%
							...
							ResultSet rs=stat.executeQuery("select * from tb_sensorinfo_1 order by id desc limit 1;");
                    ...
                    { 
                        ...
                        data:[
								...
								if(deviceId.equals("1")){
									rs2=stat.executeQuery("select * from tb_sensorinfo_1 order by id desc;");
								}else{
            ...
            xAxis: [ 
                    { 
                        ...
                        data:[
								<%
								if(deviceId.equals("1")){
									rs3=stat.executeQuery("select * from tb_sensorinfo_1 order by id desc;");
								}else{
