...
<link rel="stylesheet" type="text/css" href="css/kfout.css">
<!-- Custom Theme files -->
<!-- navigation -->
<!-- navigation -->
...
<body>
	...
	<div class="header">
		<div class="header-top">
			<div class="container">
				<p class="location">
					<i class="location"></i><span>200, xiaolinwei Street (NanJing)</span>
				</p>
				<div class="top-menu">
					<ul>
		...
		<div class="header-bottom">
			<div class="container">
				...
				<div class="top-menu" id="topmenu">
					<ul nav nav-tabs pull-right header-bottom-menu>
						<nav class="cl-effect-5 header-bottom-menu">
						...
						<li id="trans"><a href="login.jsp"><span data-hover="customeruse">客户体验</span></a>
							<ul  id="trans-nav">
					            <li><a href="login.jsp">农业物联云平台</a></li>
					            <li><a href="pumplogin.jsp">水泵物联云平台</a></li>
					        </ul>
						</li>
...
<!-- QQ联系 -->
<div id="kfoutbox" class="kfoutbox" style="top: 191px;position:fixed;">
		<div id="kfinbox" class="kfbox"><div class="kf54kefuqqtop">
			<img src="img/top.gif">
		...
		<div class="kf54kefuqqbg">
			<div class="kefu54kefunetli">
				...
				<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2145689973&site=qq&menu=yes"><img src="img/101.gif" vspace="4" border="0" align="absmiddle" title="在线咨询"></a>
				</div>
			</div>
		...
		<div class="kf54kefuqqbottom">
			...
			<!-- <a href="http://kf.300400.net/" target="_blank"><img src="img/bottom.gif"></a> -->
		</div>
		</div><div id="kfboxmenu" class="kfboxmenu kfboxmenuright"></div>
</div>

<!-- QQ联系 -->
<div id="kfoutbox" class="kfoutbox" style="top: 381px;position:fixed;">
		<div id="kfinbox" class="kfbox"><div class="kf54kefuqqtop">
			<img src="img/top.gif">
			<div id="kfboxclose" class="kfboxclose">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
		</div>
		<div class="kf54kefuqqbg">
			<div class="kefu54kefunetli">
				<div class="kefu54kefunetpicimgcenter">
				<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2498750094&site=qq&menu=yes"><img src="img/101.gif" vspace="4" border="0" align="absmiddle" title="在线咨询"></a>
				</div>
			</div>
			<div style="clear: both;"></div>
		</div>
