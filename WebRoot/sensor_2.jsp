...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
       	<ul class="nav nav-tabs" role="tablist">
       		...
       		<li role="presentation"><a href="history_2.jsp" >历史数据信息</a></li>
       		<li role="presentation"  class="active" ><a href="sensor_2.jsp">节点管理</a></li>
       	</ul>
     
      	
    		<h3>节点传感器信息</h3>
    		<form action="history_2.jsp" method="post" name="dateform">
     		<div style="height:50%">
     			<table class="table table-striped">
     				...
     				<tbody>
       				<%
						...
						ResultSet rs=stat.executeQuery("select * from sensor where node_id=2;");
