	...
	<%@ include file="sidebar.jsp" %>      
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        	<ul class="nav nav-tabs" role="tablist">
        		<li role="presentation" class="active"><a href="console_4.jsp">实时数据信息</a></li>
        		<li role="presentation"><a href="history_4.jsp">历史数据信息</a></li>
        		<li role="presentation"  ><a href="sensor_4.jsp">节点管理</a></li>
        	</ul>
