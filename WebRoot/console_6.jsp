	...
	<%@ include file="sidebar.jsp" %>      
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        	<ul class="nav nav-tabs" role="tablist">
        		<li role="presentation" class="active"><a href="console_6.jsp">实时数据信息</a></li>
        		<li role="presentation"><a href="history_6.jsp">历史数据信息</a></li>
        		<li role="presentation"  ><a href="sensor_6.jsp">节点管理</a></li>
        	</ul>
        		...
        		<div role="tabpanel" class="tab-pane fade in active" id="table">
        			...
        			<div class="row"> 	
					 	<div class="col-md-12">
							...
							ResultSet rs=stat.executeQuery("select * from tb_sensorinfo_6 order by id desc limit 50;");
				...
				datasets : [
					{
						...
						data : [
	<%
						rs=stat.executeQuery("select * from tb_sensorinfo_6 order by id desc limit 50;");
						double light=0.0;
						while(rs.next())
						{
