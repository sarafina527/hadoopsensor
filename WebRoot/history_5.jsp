...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
       	<ul class="nav nav-tabs" role="tablist">
       		<li role="presentation"><a href="console_5.jsp">实时数据信息</a></li>
       		<li role="presentation" class="active"><a href="history_5.jsp" >历史数据信息</a></li>
       		<li role="presentation"  ><a href="sensor_5.jsp">节点管理</a></li>
       	</ul>
     
       		
     		<!-- 查询表单 -->
     	<form action="history_5.jsp" method="get" name="dateform">
		 	...
		 	<div class="col-md-12">
		 		 <div class="bs-example">
					...
					<%
							...
							String sql = "select * from tb_sensorinfo_5 where DATE(date) between '"+stdate+"' and '"+enddate+"' order by id desc limit 50;";
