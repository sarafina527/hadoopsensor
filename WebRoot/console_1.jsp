...
<%@ page import="javax.naming.*,javax.sql.*,java.sql.Connection,java.sql.DriverManager,java.sql.ResultSet,java.sql.SQLException,java.sql.Statement,com.opensymphony.xwork2.ActionContext,com.wy.model.Users,com.wy.dao.NodeDao" %>
	...
	<%@ include file="sidebar.jsp" %>      
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        	...
        	<ul class="nav nav-tabs" role="tablist">
        		<li role="presentation" class="active"><a href="console_1.jsp">实时数据信息</a></li>
        		<li role="presentation"><a href="history_1.jsp">历史数据信息</a></li>
