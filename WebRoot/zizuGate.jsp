	...
	<div class="content col-md-10">
		...
		<div class="container">
			<div class="col-lg-6">
                ...
                <img src="img/cp6-2pic0.png" alt=""  width="60%"  />
            </div>

            <div class="col-lg-6">
                <h4>技术参数：</h4>
                <img src="img/cp6-3pic1.png" alt=""  />
                
            </div>
            
            <div class="col-lg-12">
                <h4>自组网网关HaiLinkw产品选型：</h4>
                <img src="img/cp6-3pic2.png" alt=""  />
