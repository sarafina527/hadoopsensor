 ...
 <script src="http://echarts.baidu.com/build/dist/echarts.js"></script>
  ...
  <div id="header">
   ...
   <%
							...
							ResultSet rs=stat.executeQuery("select * from tb_sensorinfo_3 order by id desc limit 1;");
                    ...
                    { 
                        ...
                        data:[
								...
								if(deviceId.equals("1")){
									rs2=stat.executeQuery("select * from tb_sensorinfo_3 order by id desc;");
								}else{
									rs2=stat.executeQuery("select * from tb_sensorinfo_3 order by id desc;");
								}
            ...
            xAxis: [ 
                    { 
                        ...
                        data:[
								<%
								if(deviceId.equals("1")){
									rs3=stat.executeQuery("select * from tb_sensorinfo_3 order by id desc;");
								}else{
									rs3=stat.executeQuery("select * from tb_sensorinfo_3 order by id desc;");
								}
