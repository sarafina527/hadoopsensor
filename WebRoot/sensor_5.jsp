...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
       	<ul class="nav nav-tabs" role="tablist">
       		...
       		<li role="presentation"><a href="history_5.jsp" >历史数据信息</a></li>
       		<li role="presentation"  class="active" ><a href="sensor_5.jsp">节点管理</a></li>
       	</ul>
     
      	
    		<h3>节点传感器信息</h3>
    		<form action="history_5.jsp" method="post" name="dateform">
     		<div style="height:50%">
